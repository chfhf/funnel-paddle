...
class FlaxLogitsProcessorList(list):
    """
    This class can be used to create a list of :class:`~hf_paddle.FlaxLogitsProcessor` or
    :class:`~hf_paddle.FlaxLogitsWarper` to subsequently process a :obj:`scores` input tensor. This class inherits
    from list and adds a specific `__call__` method to apply each :class:`~hf_paddle.FlaxLogitsProcessor` or
    :class:`~hf_paddle.FlaxLogitsWarper` to the inputs.
    """
...
class FlaxForcedBOSTokenLogitsProcessor(FlaxLogitsProcessor):
    r"""
    :class:`~hf_paddle.FlaxLogitsProcessor` that enforces the specified token as the first generated token.
...
class FlaxForcedEOSTokenLogitsProcessor(FlaxLogitsProcessor):
    r"""
    :class:`~hf_paddle.FlaxLogitsProcessor` that enforces the specified token as the last generated token when
...
class FlaxMinLengthLogitsProcessor(FlaxLogitsProcessor):
    r"""
    :class:`hf_paddle.FlaxLogitsProcessor` enforcing a min-length by setting EOS probability to 0.
