...
class HfDeepSpeedConfig:
    ...
    :class:`~hf_paddle.Trainer` uses the ``HfTrainerDeepSpeedConfig`` subclass instead. That subclass has logic to
    sync the configuration with values of :class:`~hf_paddle.TrainingArguments` by replacing special placeholder
...
def deepspeed_init(trainer, num_training_steps, resume_from_checkpoint=None):
    ...
    if "optimizer" in config:
        ...
        # ds supports Adam, OneBitAdam, and Lamb optimizers and can import other optimizers from paddorch.
