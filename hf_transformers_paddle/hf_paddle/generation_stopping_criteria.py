...
class MaxLengthCriteria(StoppingCriteria):
    ...
    Keep in mind for decoder-only type of hf_paddle, this will include the initial prompted tokens.
...
class MaxNewTokensCriteria(StoppingCriteria):
    ...
    Keep in mind for decoder-only type of hf_paddle, this will **not** include the initial prompted tokens. This is
