...
class TFGenerationMixin:
    ...
    :class:`~hf_paddle.TFPreTrainedModel`.
    """

    def prepare_inputs_for_generation(self, inputs, **kwargs):
        """
        Implement in subclasses of :class:`~hf_paddle.TFPreTrainedModel` for custom behavior to prepare inputs in
        the generate method.
        """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        Return:
            :class:`~hf_paddle.file_utils.ModelOutput` or :obj:`tf.Tensor`: A
            ...
            ``config.return_dict_in_generate=True``) or a :obj:`tf.Tensor`.
                ...
                possible :class:`~hf_paddle.file_utils.ModelOutput` types are:
                    ...
                    - :class:`~hf_paddle.generation_utils.TFGreedySearchDecoderOnlyOutput`,
                    - :class:`~hf_paddle.generation_utils.TFSampleDecoderOnlyOutput`,
                    - :class:`~hf_paddle.generation_utils.TFBeamSearchDecoderOnlyOutput`,
                    - :class:`~hf_paddle.generation_utils.TFBeamSampleDecoderOnlyOutput`

                If the model is an encoder-decoder model (``model.config.is_encoder_decoder=True``), the possible
                :class:`~hf_paddle.file_utils.ModelOutput` types are:

                    - :class:`~hf_paddle.generation_utils.TFGreedySearchEncoderDecoderOutput`,
                    - :class:`~hf_paddle.generation_utils.TFSampleEncoderDecoderOutput`,
                    - :class:`~hf_paddle.generation_utils.TFBeamSearchEncoderDecoderOutput`,
                    - :class:`~hf_paddle.generation_utils.TFBeamSampleEncoderDecoderOutput`
