...
class PreTrainedTokenizerFast(PreTrainedTokenizerBase):
    ...
    def set_truncation_and_padding(
        ...
        Args:
            padding_strategy (:class:`~hf_paddle.file_utils.PaddingStrategy`):
                The kind of padding that will be applied to the input
            truncation_strategy (:class:`~hf_paddle.tokenization_utils_base.TruncationStrategy`):
    ...
    def train_new_from_iterator(
        ...
        Returns:
            :class:`~hf_paddle.PreTrainedTokenizerFast`: A new tokenizer of the same type as the original one,
