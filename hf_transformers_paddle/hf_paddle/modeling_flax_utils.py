...
class FlaxPreTrainedModel(PushToHubMixin, FlaxGenerationMixin):
    ...
    :class:`~hf_paddle.FlaxPreTrainedModel` takes care of storing the configuration of the models and handles
    ...
    def from_pretrained(
        ...
        **kwargs
            ...
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~hf_paddle.FlaxPreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
        ...
        Examples::
            ...
            >>> from hf_paddle import BertConfig, FlaxBertModel
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike], params=None, push_to_hub=False, **kwargs):
        ...
        `:func:`~hf_paddle.FlaxPreTrainedModel.from_pretrained`` class method
