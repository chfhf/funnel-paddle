...
class FlaxGenerationMixin:
    ...
    :class:`~hf_paddle.FlaxPreTrainedModel`.
    """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        name inside the :class:`~hf_paddle.PretrainedConfig` of the model. The default values indicated are the
        ...
        Return:
            :class:`~hf_paddle.file_utils.ModelOutput`.

        Examples::
            >>> from hf_paddle import AutoTokenizer, FlaxAutoModelForCausalLM
    ...
    def _get_logits_warper(
        ...
        """
        This class returns a :obj:`~hf_paddle.FlaxLogitsProcessorList` list object that contains all relevant
        :obj:`~hf_paddle.FlaxLogitsWarper` instances used for multinomial sampling.
        """
    ...
    def _get_logits_processor(
        ...
        """
        This class returns a :obj:`~hf_paddle.FlaxLogitsProcessorList` list object that contains all relevant
        :obj:`~hf_paddle.FlaxLogitsProcessor` instances used to modify the scores of the language model head.
        """
