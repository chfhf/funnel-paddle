...
class AutomaticSpeechRecognitionPipeline(Pipeline):
    ...
    def __init__(self, feature_extractor: "SequenceFeatureExtractor", *args, **kwargs):
        """
        Arguments:
            feature_extractor (:obj:`~hf_paddle.SequenceFeatureExtractor`):
            ...
            model (:obj:`~hf_paddle.PreTrainedModel` or :obj:`~hf_paddle.TFPreTrainedModel`):
                ...
                from :class:`~hf_paddle.PreTrainedModel` for PyTorch and :class:`~hf_paddle.TFPreTrainedModel`
                for TensorFlow.
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~hf_paddle.AutomaticSpeechRecognitionPipeline`
