...
class Conversation:
    ...
    :class:`~hf_paddle.ConversationalPipeline`. The conversation contains a number of utility function to manage the
    addition of new user input and generated model responses. A conversation needs to contain an unprocessed user input
    before being passed to the :class:`~hf_paddle.ConversationalPipeline`. This user input is either created when
    ...
    Arguments:
        text (:obj:`str`, `optional`):
            ...
            manually using the :meth:`~hf_paddle.Conversation.add_user_input` method before the conversation can
            begin.
...
class ConversationalPipeline(Pipeline):
    ...
    This conversational pipeline can currently be loaded from :func:`~hf_paddle.pipeline` using the following task
    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        Args:
            conversations (a :class:`~hf_paddle.Conversation` or a list of :class:`~hf_paddle.Conversation`):
        ...
        Returns:
            :class:`~hf_paddle.Conversation` or a list of :class:`~hf_paddle.Conversation`: Conversation(s) with
