...
class ZeroShotClassificationPipeline(Pipeline):
    ...
    config's :attr:`~hf_paddle.PretrainedConfig.label2id`.

    This NLI pipeline can currently be loaded from :func:`~hf_paddle.pipeline` using the following task identifier:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~hf_paddle.ZeroShotClassificationPipeline`
