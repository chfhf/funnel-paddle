...
class FillMaskPipeline(Pipeline):
    ...
    This mask filling pipeline can currently be loaded from :func:`~hf_paddle.pipeline` using the following task
    ...
    def __call__(self, *args, targets=None, top_k: Optional[int] = None, **kwargs):
        ...
        results = []
        batch_size = outputs.shape[0] if self.framework == "tf" else outputs.shape[0]
