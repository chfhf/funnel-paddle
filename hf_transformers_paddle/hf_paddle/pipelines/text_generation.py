...
class TextGenerationPipeline(Pipeline):
    ...
    This language generation pipeline can currently be loaded from :func:`~hf_paddle.pipeline` using the following
        ...
        **generate_kwargs
        ...
        for prompt_text in text_inputs:
            ...
            with self.device_placement():
                ...
                ), "Batch generation is currently not supported. See https://github.com/huggingface/hf_paddle/issues/3021 for more information."
