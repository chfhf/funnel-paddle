...
def pipeline(
    ...
    **kwargs
    ...
    """
    Utility factory method to build a :class:`~hf_paddle.Pipeline`.
    ...
    Args:
        task (:obj:`str`):
            ...
            - :obj:`"feature-extraction"`: will return a :class:`~hf_paddle.FeatureExtractionPipeline`.
            - :obj:`"text-classification"`: will return a :class:`~hf_paddle.TextClassificationPipeline`.
            - :obj:`"sentiment-analysis"`: (alias of :obj:`"text-classification") will return a
              :class:`~hf_paddle.TextClassificationPipeline`.
            - :obj:`"token-classification"`: will return a :class:`~hf_paddle.TokenClassificationPipeline`.
            - :obj:`"ner"` (alias of :obj:`"token-classification"): will return a
              :class:`~hf_paddle.TokenClassificationPipeline`.
            - :obj:`"question-answering"`: will return a :class:`~hf_paddle.QuestionAnsweringPipeline`.
            - :obj:`"fill-mask"`: will return a :class:`~hf_paddle.FillMaskPipeline`.
            - :obj:`"summarization"`: will return a :class:`~hf_paddle.SummarizationPipeline`.
            - :obj:`"translation_xx_to_yy"`: will return a :class:`~hf_paddle.TranslationPipeline`.
            - :obj:`"text2text-generation"`: will return a :class:`~hf_paddle.Text2TextGenerationPipeline`.
            - :obj:`"text-generation"`: will return a :class:`~hf_paddle.TextGenerationPipeline`.
            - :obj:`"zero-shot-classification:`: will return a :class:`~hf_paddle.ZeroShotClassificationPipeline`.
            - :obj:`"conversational"`: will return a :class:`~hf_paddle.ConversationalPipeline`.
        model (:obj:`str` or :obj:`~hf_paddle.PreTrainedModel` or :obj:`~hf_paddle.TFPreTrainedModel`, `optional`):
            The model that will be used by the pipeline to make predictions. This can be a model identifier or an
            actual instance of a pretrained model inheriting from :class:`~hf_paddle.PreTrainedModel` (for PyTorch)
            or :class:`~hf_paddle.TFPreTrainedModel` (for TensorFlow).

            If not provided, the default for the :obj:`task` will be loaded.
        config (:obj:`str` or :obj:`~hf_paddle.PretrainedConfig`, `optional`):
            The configuration that will be used by the pipeline to instantiate the model. This can be a model
            identifier or an actual pretrained model configuration inheriting from
            :class:`~hf_paddle.PretrainedConfig`.
        ...
        tokenizer (:obj:`str` or :obj:`~hf_paddle.PreTrainedTokenizer`, `optional`):
            The tokenizer that will be used by the pipeline to encode data for the model. This can be a model
            identifier or an actual pretrained tokenizer inheriting from :class:`~hf_paddle.PreTrainedTokenizer`.
        ...
        feature_extractor (:obj:`str` or :obj:`~hf_paddle.PreTrainedFeatureExtractor`, `optional`):
            The feature extractor that will be used by the pipeline to encode data for the model. This can be a model
            identifier or an actual pretrained feature extractor inheriting from
            :class:`~hf_paddle.PreTrainedFeatureExtractor`.
        ...
        use_fast (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether or not to use a Fast tokenizer if possible (a :class:`~hf_paddle.PreTrainedTokenizerFast`).
    ...
    Returns:
        :class:`~hf_paddle.Pipeline`: A suitable pipeline for the task.

    Examples::

        >>> from hf_paddle import pipeline, AutoModelForTokenClassification, AutoTokenizer
