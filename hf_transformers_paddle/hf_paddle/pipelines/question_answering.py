...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    internal :class:`~hf_paddle.SquadExample`.

    QuestionAnsweringArgumentHandler manages all the possible to create a :class:`~hf_paddle.SquadExample` from the
...
class QuestionAnsweringPipeline(Pipeline):
    ...
    This question answering pipeline can currently be loaded from :func:`~hf_paddle.pipeline` using the following
    ...
    def create_sample(
        ...
        """
        QuestionAnsweringPipeline leverages the :class:`~hf_paddle.SquadExample` internally. This helper method
        encapsulate all the logic for converting question(s) and context(s) to :class:`~hf_paddle.SquadExample`.
        ...
        Returns:
            One or a list of :class:`~hf_paddle.SquadExample`: The corresponding :class:`~hf_paddle.SquadExample`
    ...
    def __call__(self, *args, **kwargs):
        ...
        Args:
            args (:class:`~hf_paddle.SquadExample` or a list of :class:`~hf_paddle.SquadExample`):
                One or several :class:`~hf_paddle.SquadExample` containing the question and context.
            X (:class:`~hf_paddle.SquadExample` or a list of :class:`~hf_paddle.SquadExample`, `optional`):
                One or several :class:`~hf_paddle.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
            data (:class:`~hf_paddle.SquadExample` or a list of :class:`~hf_paddle.SquadExample`, `optional`):
                One or several :class:`~hf_paddle.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
