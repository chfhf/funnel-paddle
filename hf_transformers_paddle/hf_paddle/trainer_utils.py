...
class BestRun(NamedTuple):
    """
    The best run found by an hyperparameter search (see :class:`~hf_paddle.Trainer.hyperparameter_search`).
...
def default_compute_objective(metrics: Dict[str, float]) -> float:
    ...
    metrics are provided to the :class:`~hf_paddle.Trainer`, the sum of all metrics otherwise.
...
class TrainerMemoryTracker:
    ...
    To understand this class' intricacies please read the documentation of :meth:`~hf_paddle.Trainer.log_metrics`.
