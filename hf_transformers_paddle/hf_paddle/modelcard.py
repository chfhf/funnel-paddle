...
class ModelCard:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        r"""
        Instantiate a :class:`~hf_paddle.ModelCard` from a pre-trained model model card.
        ...
        Parameters:
            pretrained_model_name_or_path: either:
                ...
                - a path to a `directory` containing a model card file saved using the
                  :func:`~hf_paddle.ModelCard.save_pretrained` method, e.g.: ``./my_model_directory/``.
        ...
        from hf_paddle.models.auto.configuration_auto import ALL_PRETRAINED_CONFIG_ARCHIVE_MAP
