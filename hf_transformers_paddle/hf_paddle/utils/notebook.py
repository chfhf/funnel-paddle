...
class NotebookProgressBar:
    ...
    Args:
        ...
        leave (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            :meth:`~hf_paddle.utils.notebook.NotebookProgressBar.close` method to make the bar disappear.
        parent (:class:`~hf_paddle.notebook.NotebookTrainingTracker`, `optional`):
            A parent object (like :class:`~hf_paddle.utils.notebook.NotebookTrainingTracker`) that spawns progress
...
class NotebookTrainingTracker(NotebookProgressBar):
    ...
    Args:
        ...
        column_names (:obj:`List[str]`, `optional`):
            ...
            :meth:`~hf_paddle.utils.notebook.NotebookTrainingTracker.write_line` if not set).
    """
...
class NotebookProgressCallback(TrainerCallback):
    """
    A :class:`~hf_paddle.TrainerCallback` that displays the progress of training or evaluation, optimized for
