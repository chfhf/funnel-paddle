...
from paddorch.fx import Graph, GraphModule, Node, Proxy, Tracer
from paddorch.fx.node import Argument

from hf_paddle.file_utils import TORCH_FX_REQUIRED_VERSION, importlib_metadata, is_torch_fx_available
...
def symbolic_trace(
    ...
    Example::
        ...
        from hf_paddle.utils.fx import symbolic_trace
