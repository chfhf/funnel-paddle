...
class CanineModelOutputWithPooling(ModelOutput):
    """
    Output type of :class:`~hf_paddle.CanineModel`. Based on
    :class:`~hf_paddle.modeling_outputs.BaseModelOutputWithPooling`, but with slightly different
...
CANINE_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.CanineConfig`): Model configuration class with all the parameters of the model.
...
CANINE_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`hf_paddle.CanineTokenizer`. See
