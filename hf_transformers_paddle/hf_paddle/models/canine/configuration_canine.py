...
class CanineConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.CanineModel`. It is used to
    ...
    Args:
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 16):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.CanineModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import CanineModel, CanineConfig
