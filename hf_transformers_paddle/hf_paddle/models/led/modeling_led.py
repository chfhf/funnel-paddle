...
# Copied from hf_paddle.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from hf_paddle.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.LEDConfig`):
...
LED_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> import paddorch as torch
        >>> from hf_paddle import LEDTokenizer, LEDForConditionalGeneration
...
LED_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.LEDTokenizer`. See
...
class LEDEncoder(LEDPreTrainedModel):
    ...
    def forward(
        ...
        if attention_mask is None:
            attention_mask = torch.ones(inputs_embeds.shape[:-1], device=inputs_embeds.device, dtype=torch.long)
...
class LEDModel(LEDPreTrainedModel):
    ...
    def forward(
        ...
        # https://github.com/huggingface/hf_paddle/blob/ac3cb660cad283163f7c73cad511124e845ca388/src/hf_paddle/models/bart/modeling_bart.py#L1153
