...
# Copied from hf_paddle.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from hf_paddle.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
LED_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~hf_paddle.LEDConfig`): Model configuration class with all the parameters of the model.
    ...
    def call(
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
                provide it. Indices can be obtained using :class:`~hf_paddle.LEDTokenizer`. See
                :meth:`hf_paddle.PreTrainedTokenizer.encode` and :meth:`hf_paddle.PreTrainedTokenizer.__call__`
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from hf_paddle import LEDTokenizer, TFLEDForConditionalGeneration
            >>> import tensorflow as tf
