...
class LEDConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.LEDModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.LEDModel` or :class:`~hf_paddle.TFLEDModel`.
        ...
        >>> from hf_paddle import LEDModel, LEDConfig
