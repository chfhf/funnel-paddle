...
# Copied from hf_paddle.models.bart.modeling_bart.BartAttention with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_bart.BartEncoderLayer with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_bart.BartDecoderLayer with Bart->Marian
...
MARIAN_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.MarianConfig`):
...
MARIAN_GENERATION_EXAMPLE = r"""
        ...
        Examples::
            ...
            >>> from hf_paddle import MarianTokenizer, MarianMTModel
...
MARIAN_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.MarianTokenizer`. See
...
class MarianModel(MarianPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import MarianTokenizer, MarianModel
...
class MarianMTModel(MarianPreTrainedModel):
    ...
    def adjust_logits_during_generation(self, logits, cur_len):
        logits[:, self.config.pad_token_id] = -1e+20  # never predict pad token.
        return logits
...
# Copied from hf_paddle.models.bart.modeling_bart.BartDecoderWrapper with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_bart.BartForCausalLM with Bart->Marian
class MarianForCausalLM(MarianPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import MarianTokenizer, MarianForCausalLM
