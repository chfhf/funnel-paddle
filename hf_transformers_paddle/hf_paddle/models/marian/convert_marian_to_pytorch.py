...
from hf_paddle import MarianConfig, MarianMTModel, MarianTokenizer
from hf_paddle.hf_api import HfApi
...
def get_system_metadata(repo_root):
    ...
    return dict(
        ...
        hf_paddle_git_sha=git.Repo(path=".", search_parent_directories=True).head.object.hexsha,
