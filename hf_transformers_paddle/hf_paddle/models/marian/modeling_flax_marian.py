...
# Copied from hf_paddle.models.bart.modeling_flax_bart.shift_tokens_right
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartEncoderLayer with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartEncoderLayerCollection with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartDecoderLayer with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartDecoderLayerCollection with Bart->Marian
...
class FlaxMarianPreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        Example::
            ...
            >>> from hf_paddle import MarianTokenizer, FlaxMarianMTModel
...
class FlaxMarianMTModel(FlaxMarianPreTrainedModel):
    ...
    def _adapt_logits_for_beam_search(self, logits):
        ...
        logits = jax.ops.index_update(logits, jax.ops.index[:, :, self.config.pad_token_id], -1e+20)
        return logits
