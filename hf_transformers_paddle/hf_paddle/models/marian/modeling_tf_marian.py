...
# Copied from hf_paddle.models.bart.modeling_tf_bart.TFBartAttention with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_tf_bart.TFBartEncoderLayer with Bart->Marian
...
# Copied from hf_paddle.models.bart.modeling_tf_bart.TFBartDecoderLayer with Bart->Marian
...
MARIAN_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~hf_paddle.MarianConfig`): Model configuration class with all the parameters of the model.
...
MARIAN_GENERATION_EXAMPLE = r"""
        ...
        Examples::
            ...
            >>> from hf_paddle import MarianTokenizer, TFMarianMTModel
