...
class TapasTruncationStrategy(ExplicitEnum):
    """
    Possible values for the ``truncation`` argument in :meth:`~hf_paddle.TapasTokenizer.__call__`. Useful for
...
TAPAS_ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            padding (:obj:`bool`, :obj:`str` or :class:`~hf_paddle.file_utils.PaddingStrategy`, `optional`, defaults to :obj:`False`):
                ...
                * :obj:`False` or :obj:`'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of
                  different lengths).
            truncation (:obj:`bool`, :obj:`str` or :class:`~hf_paddle.TapasTruncationStrategy`, `optional`, defaults to :obj:`False`):
...
class TapasTokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~hf_paddle.PreTrainedTokenizer` which contains most of the main methods.
    Users should refer to this superclass for more information regarding those methods.
    :class:`~hf_paddle.TapasTokenizer` creates several token type ids to encode tabular structure. To be more
    ...
    :class:`~hf_paddle.TapasTokenizer` runs end-to-end tokenization on a table and associated sentences: punctuation
    ...
    Args:
        ...
        tokenize_chinese_chars (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            `issue <https://github.com/huggingface/hf_paddle/issues/328>`__).
        ...
        **kwargs
        ...
        if return_offsets_mapping:
            raise NotImplementedError(
                ...
                "hf_paddle.PreTrainedTokenizerFast."
            )
    ...
    def _get_truncated_table_rows(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :obj:`~hf_paddle.TapasTruncationStrategy`):
    ...
    def convert_logits_to_predictions(self, data, logits, logits_agg=None, cell_classification_threshold=0.5):
        """
        Converts logits of :class:`~hf_paddle.TapasForQuestionAnswering` to actual predicted answer coordinates and
        ...
        Args:
            data (:obj:`dict`):
                ...
                :class:`~hf_paddle.TapasTokenizer`.
...
# Copied from hf_paddle.models.bert.tokenization_bert.BasicTokenizer
class BasicTokenizer(object):
    ...
    Args:
        ...
        tokenize_chinese_chars (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            <https://github.com/huggingface/hf_paddle/issues/328>`__).
        strip_accents: (:obj:`bool`, `optional`):
            Whether or not to strip all accents. If this option is not specified, then it will be determined by the
            value for :obj:`lowercase` (as in the original BERT).
    """
...
# Copied from hf_paddle.models.bert.tokenization_bert.WordpieceTokenizer
