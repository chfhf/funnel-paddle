...
class TapasConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.TapasModel`. It is used to
    ...
    architecture. Configuration objects inherit from :class:`~hf_paddle.PreTrainedConfig` and can be used to control
    the model outputs. Read the documentation from :class:`~hf_paddle.PretrainedConfig` for more information.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.TapasModel`.
        ...
        type_vocab_sizes (:obj:`List[int]`, `optional`, defaults to :obj:`[3, 256, 256, 2, 256, 256, 10]`):
            The vocabulary sizes of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.TapasModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import TapasModel, TapasConfig
