...
class BlenderbotConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.BlenderbotModel`. It is used
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BlenderbotModel` or
            :class:`~hf_paddle.TFBlenderbotModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import BlenderbotModel, BlenderbotConfig
