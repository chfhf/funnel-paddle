...
# Copied from hf_paddle.models.bart.modeling_tf_bart.TFBartAttention with Bart->Blenderbot
...
# Copied from hf_paddle.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Blenderbot
...
# Copied from hf_paddle.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~hf_paddle.BlenderbotConfig`): Model configuration class with all the parameters of the model.
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from hf_paddle import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration
