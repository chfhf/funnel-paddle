...
if TYPE_CHECKING:
    from hf_paddle.pipelines.conversational import Conversation
...
class BlenderbotTokenizer(RobertaTokenizer):
    ...
    :class:`~hf_paddle.Blenderbot` is nearly identical to :class:`~hf_paddle.RobertaTokenizer` and runs
    ...
    Refer to superclass :class:`~hf_paddle.RobertaTokenizer` for usage examples and documentation concerning
    parameters.
    """
