...
from hf_paddle import PreTrainedTokenizer, TensorType
...
class T5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.T5Model` or a
    :class:`~hf_paddle.TFT5Model`. It is used to instantiate a T5 model according to the specified arguments,
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 32128):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.T5Model` or :class:`~hf_paddle.TFT5Model`.
