...
T5_ENCODER_INPUTS_DOCSTRING = r"""
    Args:
        inputs (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.T5Tokenizer`. See
            :func:`hf_paddle.PreTrainedTokenizer.__call__` and :func:`hf_paddle.PreTrainedTokenizer.encode` for
            details.
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from hf_paddle import T5Tokenizer, TFT5Model
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from hf_paddle import T5Tokenizer, TFT5ForConditionalGeneration
