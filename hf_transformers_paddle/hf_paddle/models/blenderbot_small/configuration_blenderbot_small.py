...
class BlenderbotSmallConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.BlenderbotSmallModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            represented by the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BlenderbotSmallModel` or
            :class:`~hf_paddle.TFBlenderbotSmallModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import BlenderbotSmallModel, BlenderbotSmallConfig
