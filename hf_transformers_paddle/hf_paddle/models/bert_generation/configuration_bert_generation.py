...
class BertGenerationConfig(PretrainedConfig):
    ...
    :class:`~hf_paddle.BertGenerationPreTrainedModel`. It is used to instantiate a BertGeneration model according to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50358):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BertGeneration`.
    ...
    Examples::
        ...
        >>> from hf_paddle import BertGenerationConfig, BertGenerationEncoder
