...
BERT_GENERATION_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.BertGenerationConfig`): Model configuration class with all the parameters of the model.
...
BERT_GENERATION_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.BertGenerationTokenizer`. See
...
class BertGenerationEncoder(BertGenerationPreTrainedModel):
    ...
    :class:`~hf_paddle.EncoderDecoderModel` class as described in `Leveraging Pre-trained Checkpoints for Sequence
...
class BertGenerationDecoder(BertGenerationPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
            >>> import paddorch as torch
