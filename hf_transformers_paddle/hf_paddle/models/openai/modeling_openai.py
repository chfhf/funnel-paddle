...
class OpenAIGPTDoubleHeadsModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import OpenAIGPTTokenizer, OpenAIGPTDoubleHeadsModel
            >>> import paddorch as torch
...
@add_start_docstrings(
    ...
    :class:`~hf_paddle.OpenAIGPTForSequenceClassification` uses the last token in order to do the classification, as
