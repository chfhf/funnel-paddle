...
class OpenAIGPTConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.OpenAIGPTModel` or a
    :class:`~hf_paddle.TFOpenAIGPTModel`. It is used to instantiate a GPT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 40478):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.OpenAIGPTModel` or
            :class:`~hf_paddle.TFOpenAIGPTModel`.
        ...
        summary_type (:obj:`str`, `optional`, defaults to :obj:`"cls_index"`):
            ...
            :class:`~hf_paddle.OpenAIGPTDoubleHeadsModel` and :class:`~hf_paddle.OpenAIGPTDoubleHeadsModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import OpenAIGPTConfig, OpenAIGPTModel
