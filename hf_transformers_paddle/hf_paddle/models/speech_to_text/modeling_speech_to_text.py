...
# Copied from hf_paddle.models.bart.modeling_bart.BartAttention with Bart->Speech2Text
...
SPEECH_TO_TEXT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.Speech2TextConfig`):
...
SPEECH_TO_TEXT_INPUTS_DOCSTRING = r"""
    Args:
        input_features (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length, feature_size)`):
            ...
            into :obj:`input_features`, the :class:`~hf_paddle.Speech2TextTokenizer` should be used for extracting
            the fbank features, padding and conversion into a tensor of type :obj:`torch.FloatTensor`. See
            :meth:`~hf_paddle.Speech2TextTokenizer.__call__`
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~hf_paddle.SpeechToTextTokenizer`. See
    ...
    def forward(
        ...
        Args:
            input_features (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length, feature_size)`):
                ...
                array into :obj:`input_features`, the :class:`~hf_paddle.Speech2TextTokenizer` should be used for
                extracting the fbank features, padding and conversion into a tensor of type :obj:`torch.FloatTensor`.
                See :meth:`~hf_paddle.Speech2TextTokenizer.__call__`
            attention_mask (:obj:`torch.Tensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
    ...
    def forward(
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~hf_paddle.Speech2TextTokenizer`. See
...
class Speech2TextForConditionalGeneration(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> import paddorch as torch
            >>> from hf_paddle import Speech2TextProcessor, Speech2TextForConditionalGeneration
