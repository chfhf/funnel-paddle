...
from hf_paddle import ProphetNetForConditionalGeneration, XLMProphetNetForConditionalGeneration, logging

# hf_paddle_old should correspond to branch `save_old_prophetnet_model_structure` here
# original prophetnet_checkpoints are saved under `patrickvonplaten/..._old` respectively
from hf_paddle_old.modeling_prophetnet import (
    ProphetNetForConditionalGeneration as ProphetNetForConditionalGenerationOld,
)
from hf_paddle_old.modeling_xlm_prophetnet import (
