...
CLASS_DOCSTRING = """
    ...
    with the :meth:`~hf_paddle.BaseAutoModelClass.from_pretrained` class method or the
    :meth:`~hf_paddle.BaseAutoModelClass.from_config` class method.
...
FROM_CONFIG_DOCSTRING = """
        ...
        Note:
            ...
            model's configuration. Use :meth:`~hf_paddle.BaseAutoModelClass.from_pretrained` to load the model
            weights.
        ...
        Examples::
            ...
            >>> from hf_paddle import AutoConfig, BaseAutoModelClass
...
FROM_PRETRAINED_TORCH_DOCSTRING = """
        ...
        Args:
            ...
            config (:class:`~hf_paddle.PretrainedConfig`, `optional`):
                Configuration for the model to use instead of an automatically loaded configuration. Configuration can
                be automatically loaded when:

                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :meth:`~hf_paddle.PreTrainedModel.save_pretrained` and is reloaded
