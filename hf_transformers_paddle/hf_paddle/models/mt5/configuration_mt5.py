...
class MT5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.MT5Model` or a
    :class:`~hf_paddle.TFMT5Model`. It is used to instantiate a mT5 model according to the specified arguments,
