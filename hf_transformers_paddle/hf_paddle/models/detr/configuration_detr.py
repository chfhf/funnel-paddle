...
class DetrConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.DetrModel`. It is used to
    ...
    Args:
        num_queries (:obj:`int`, `optional`, defaults to 100):
            ...
            :class:`~hf_paddle.DetrModel` can detect in a single image. For COCO, we recommend 100 queries.
    ...
    Examples::
        ...
        >>> from hf_paddle import DetrModel, DetrConfig
