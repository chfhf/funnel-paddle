...
class DetrObjectDetectionOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.DetrForObjectDetection`.
    ...
    Args:
        ...
        pred_boxes (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_queries, 4)`):
            ...
            possible padding). You can use :meth:`~hf_paddle.DetrFeatureExtractor.post_process` to retrieve the
...
class DetrSegmentationOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.DetrForSegmentation`.
    ...
    Args:
        ...
        pred_masks (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_queries, height/4, width/4)`):
            ...
            :meth:`~hf_paddle.DetrFeatureExtractor.post_process_segmentation` or
            :meth:`~hf_paddle.DetrFeatureExtractor.post_process_panoptic` to evaluate instance and panoptic
...
class DetrFrozenBatchNorm2d(nn.Module):
    ...
    Copy-paste from paddorchvision.misc.ops with added eps before rqsrt, without which any other models than
...
DETR_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.DetrConfig`):
...
DETR_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_channels, height, width)`):
            ...
            Pixel values can be obtained using :class:`~hf_paddle.DetrFeatureExtractor`. See
            :meth:`hf_paddle.DetrFeatureExtractor.__call__` for details.
...
class DetrModel(DetrPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import DetrFeatureExtractor, DetrModel
...
class DetrForObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import DetrFeatureExtractor, DetrForObjectDetection
            >>> from PIL import Image
            >>> import requests
...
class DetrForSegmentation(DetrPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import DetrFeatureExtractor, DetrForSegmentation
            >>> from PIL import Image
            >>> import requests
...
class DetrMHAttentionMap(nn.Module):
    ...
    def forward(self, q, k, mask: Optional[Tensor] = None):
        ...
        if mask is not None:
            weights.masked_fill_(mask.unsqueeze(1).unsqueeze(1), -1e+20)
        weights = nn.functional.softmax(weights.flatten(2), dim=-1).view(weights.shape)
...
# modified from paddorchvision to also return the union
