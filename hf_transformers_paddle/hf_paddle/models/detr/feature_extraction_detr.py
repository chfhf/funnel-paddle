...
class DetrFeatureExtractor(FeatureExtractionMixin, ImageFeatureExtractionMixin):
    ...
    This feature extractor inherits from :class:`~hf_paddle.FeatureExtractionMixin` which contains most of the main
        ...
        **kwargs,
        ...
        Args:
            ...
            annotations (:obj:`Dict`, :obj:`List[Dict]`, `optional`):
                ...
                In case :class:`~hf_paddle.DetrFeatureExtractor` was initialized with :obj:`format =
            ...
            masks_path (:obj:`pathlib.Path`, `optional`):
                ...
                relevant in case :class:`~hf_paddle.DetrFeatureExtractor` was initialized with :obj:`format =
                "coco_panoptic"`.
        ...
        Returns:
            :class:`~hf_paddle.BatchFeature`: A :class:`~hf_paddle.BatchFeature` with the following fields:
    ...
    def post_process(self, outputs, target_sizes):
        """
        Converts the output of :class:`~hf_paddle.DetrForObjectDetection` into the format expected by the COCO api.
        Only supports PyTorch.

        Args:
            outputs (:class:`~hf_paddle.DetrObjectDetectionOutput`):
    ...
    def post_process_segmentation(self, results, outputs, orig_target_sizes, max_target_sizes, threshold=0.5):
        """
        Converts the output of :class:`~hf_paddle.DetrForSegmentation` into actual instance segmentation
        predictions. Only supports PyTorch.

        Args:
            results (:obj:`List[Dict]`):
                Results list obtained by :meth:`~hf_paddle.DetrFeatureExtractor.post_process`, to which "masks"
                results will be added.
            outputs (:class:`~hf_paddle.DetrSegmentationOutput`):
                Raw outputs of the model.
    ...
    def post_process_panoptic(self, outputs, processed_sizes, target_sizes=None, is_thing_map=None, threshold=0.85):
        """
        Converts the output of :class:`~hf_paddle.DetrForSegmentation` into actual panoptic predictions. Only
        supports PyTorch.
