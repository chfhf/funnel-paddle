...
class BigBirdPegasusConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.BigBirdPegasusModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 96103):
            ...
            by the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BigBirdPegasusModel`.
        ...
        >>> from hf_paddle import BigBirdPegasusModel, BigBirdPegasusConfig
