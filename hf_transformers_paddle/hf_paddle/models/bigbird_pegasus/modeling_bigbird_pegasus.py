...
from paddorch.nn import CrossEntropyLoss, MSELoss
...
def _make_causal_mask(input_ids_shape: torch.Size, dtype: torch.dtype, past_key_values_length: int = 0):
    ...
    mask = torch.full((tgt_len, tgt_len), -1e+20)
...
# Copied from hf_paddle.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBird->BigBirdPegasus
...
# Copied from hf_paddle.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBird->BigBirdPegasus
...
# Copied from hf_paddle.models.bart.modeling_bart.BartAttention with Bart->BigBirdPegasusDecoder
...
class BigBirdPegasusDecoderLayer(nn.Module):
    ...
    # Copied from hf_paddle.models.mbart.modeling_mbart.MBartDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from hf_paddle.models.bart.modeling_bart.BartClassificationHead with Bart->BigBirdPegasus
...
BIGBIRD_PEGASUS_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.BigBirdPegasusConfig`):
            Model configuration class with all the parameters of the model. Initializing with a config file does not
            load the weights associated with the model, only the configuration. Check out the
            :meth:`~hf_paddle.PreTrainedModel.from_pretrained` method to load the model weights.
"""

BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    Summarization example::

        >>> from hf_paddle import PegasusTokenizer, BigBirdPegasusForConditionalGeneration, BigBirdPegasusConfig
...
BIGBIRD_PEGASUS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.PegasusTokenizer`. See
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~hf_paddle.PegasusTokenizer`. See
                :meth:`hf_paddle.PreTrainedTokenizer.encode` and :meth:`hf_paddle.PreTrainedTokenizer.__call__`
                for details.
    ...
    @staticmethod  # Copied from hf_paddle.models.big_bird.modeling_big_bird.BigBirdModel.create_masks_for_block_sparse_attn
...
class BigBirdPegasusDecoder(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from hf_paddle.models.bart.modeling_bart.BartDecoder._prepare_decoder_attention_mask
    ...
    def forward(
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~hf_paddle.BigBirdPegasusTokenizer`. See
                :meth:`hf_paddle.PreTrainedTokenizer.encode` and :meth:`hf_paddle.PreTrainedTokenizer.__call__`
                for details.
...
# Copied from hf_paddle.models.bart.modeling_bart.BartModel with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from hf_paddle.models.bart.modeling_bart.BartForConditionalGeneration with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from hf_paddle.models.bart.modeling_bart.BartForSequenceClassification with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from hf_paddle.models.bart.modeling_bart.BartForQuestionAnswering with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from hf_paddle.models.pegasus.modeling_pegasus.PegasusDecoderWrapper with Pegasus->BigBirdPegasus
class BigBirdPegasusDecoderWrapper(BigBirdPegasusPreTrainedModel):
    """
    This wrapper class is a helper class to correctly load pretrained checkpoints when the causal language model is
    used in combination with the :class:`~hf_paddle.EncoderDecoderModel` framework.
    """
...
# Copied from hf_paddle.models.pegasus.modeling_pegasus.PegasusForCausalLM with Pegasus->BigBirdPegasus, 'facebook/bart-large'->"google/bigbird-pegasus-large-arxiv"
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import BigBirdPegasusTokenizer, BigBirdPegasusForCausalLM
