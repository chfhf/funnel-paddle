...
class DistilBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.DistilBertModel` or a
    :class:`~hf_paddle.TFDistilBertModel`. It is used to instantiate a DistilBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.DistilBertModel` or
            :class:`~hf_paddle.TFDistilBertModel`.
        ...
        qa_dropout (:obj:`float`, `optional`, defaults to 0.1):
            ...
            :class:`~hf_paddle.DistilBertForQuestionAnswering`.
        seq_classif_dropout (:obj:`float`, `optional`, defaults to 0.2):
            The dropout probabilities used in the sequence classification and the multiple choice model
            :class:`~hf_paddle.DistilBertForSequenceClassification`.

    Examples::

        >>> from hf_paddle import DistilBertModel, DistilBertConfig
