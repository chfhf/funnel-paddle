...
FUNNEL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.XxxConfig`): Model configuration class with all the parameters of the model.
...
FUNNEL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.FunnelTokenizer`. See
    ...
    def call(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from hf_paddle import FunnelTokenizer, TFFunnelForPreTraining
