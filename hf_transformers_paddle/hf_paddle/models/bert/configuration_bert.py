...
class BertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.BertModel` or a
    :class:`~hf_paddle.TFBertModel`. It is used to instantiate a BERT model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BertModel` or
            :class:`~hf_paddle.TFBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.BertModel` or
            :class:`~hf_paddle.TFBertModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import BertModel, BertConfig
