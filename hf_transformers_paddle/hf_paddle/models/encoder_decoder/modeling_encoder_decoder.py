...
ENCODER_DECODER_START_DOCSTRING = r"""
    ...
    :meth:`~hf_paddle.AutoModel.from_pretrained` function and the decoder is loaded via
    :meth:`~hf_paddle.AutoModelForCausalLM.from_pretrained` function. Cross-attention layers are automatically added
    ...
    Parameters:
        config (:class:`~hf_paddle.T5Config`): Model configuration class with all the parameters of the model.
...
ENCODER_DECODER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.PreTrainedTokenizer`. See
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            :class:`~hf_paddle.PreTrainedTokenizer`. See :meth:`hf_paddle.PreTrainedTokenizer.encode` and
        ...
        return_dict (:obj:`bool`, `optional`):
            If set to ``True``, the model will return a :class:`~hf_paddle.file_utils.Seq2SeqLMOutput` instead of a
            plain tuple.
...
class EncoderDecoderModel(PreTrainedModel):
    r"""
    :class:`~hf_paddle.EncoderDecoder` is a generic model class that will be instantiated as a transformer
    architecture with one of the base model classes of the library as encoder and another one as decoder when created
    with the :meth`~hf_paddle.AutoModel.from_pretrained` class method for the encoder and
    :meth`~hf_paddle.AutoModelForCausalLM.from_pretrained` class method for the decoder.
    """
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        Example::
            ...
            >>> from hf_paddle import EncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from hf_paddle import EncoderDecoderModel, BertTokenizer
