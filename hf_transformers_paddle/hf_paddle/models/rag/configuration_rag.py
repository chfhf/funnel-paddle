...
RAG_CONFIG_DOC = r"""
    :class:`~hf_paddle.RagConfig` stores the configuration of a `RagModel`. Configuration objects inherit from
    :class:`~hf_paddle.PretrainedConfig` and can be used to control the model outputs. Read the documentation from
    :class:`~hf_paddle.PretrainedConfig` for more information.
    ...
    Args:
        ...
        max_combined_length (:obj:`int`, `optional`, defaults to 300):
            Max length of contextualized input returned by :meth:`~hf_paddle.RagRetriever.__call__`.
        retrieval_vector_size (:obj:`int`, `optional`, defaults to 768):
            Dimensionality of the document embeddings indexed by :class:`~hf_paddle.RagRetriever`.
        ...
        passages_path: (:obj:`str`, `optional`):
            ...
            :class:`~hf_paddle.models.rag.retrieval_rag.LegacyIndex`
...
class RagConfig(PretrainedConfig):
    ...
    def from_question_encoder_generator_configs(
        ...
        r"""
        Instantiate a :class:`~hf_paddle.EncoderDecoderConfig` (or a derived class) from a pre-trained encoder model
