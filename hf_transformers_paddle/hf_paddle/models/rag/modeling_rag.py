    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        Example::
            ...
            >>> from hf_paddle import RagModel
...
RAG_START_DOCSTRING = r"""
    ...
    The question encoder can be any `autoencoding` model, preferably :class:`~hf_paddle.DPRQuestionEncoder`, and the
    generator can be any `seq2seq` model, preferably :class:`~hf_paddle.BartForConditionalGeneration`.
    ...
    the ``generator``. It has been tested with :class:`~hf_paddle.DPRQuestionEncoder` as the ``question_encoder``
    and :class:`~hf_paddle.BartForConditionalGeneration` or :class:`~hf_paddle.T5ForConditionalGeneration` as the
    ``generator``.
    ...
    Args:
        ...
        question_encoder (:class:`hf_paddle.PreTrainedModel`):
            An encoder model compatible with the faiss index encapsulated by the ``retriever``.
        generator (:class:`hf_paddle.PreTrainedModel`):
...
RAG_FORWARD_INPUTS_DOCSTRING = r"""
    Args:
        ...
        encoder_outputs (:obj:`tuple(tuple(torch.FloatTensor)`, `optional`)
            ...
            Used by the (:class:`~hf_paddle.RagModel`) model during decoding.
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        Example::
            ...
            >>> from hf_paddle import RagTokenizer, RagRetriever, RagSequenceForGeneration
            >>> import paddorch as torch
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        Example::
            ...
            >>> from hf_paddle import RagTokenizer, RagRetriever, RagTokenForGeneration
            >>> import paddorch as torch
