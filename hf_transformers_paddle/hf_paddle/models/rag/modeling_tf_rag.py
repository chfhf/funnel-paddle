    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        Params:
            question_encoder_pretrained_model_name_or_path (:obj: `str`, `optional`):
                Information necessary to initiate the question encoder. Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~hf_paddle.TFPreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
            ...
            retriever (:class:`~hf_paddle.RagRetriever`, `optional`):
        ...
        Example::
            ...
            >>> from hf_paddle import RagRetriever, TFRagModel
...
RAG_START_DOCSTRING = r"""
    ...
    The question encoder can be any `autoencoding` model, preferably :class:`~hf_paddle.TFDPRQuestionEncoder`, and
    the generator can be any `seq2seq` model, preferably :class:`~hf_paddle.TFBartForConditionalGeneration`.

    The model can be initialized with a :class:`~hf_paddle.RagRetriever` for end-to-end generation or used in
    ...
    the ``generator``. It has been tested with :class:`~hf_paddle.TFDPRQuestionEncoder` as the ``question_encoder``
    and :class:`~hf_paddle.TFBartForConditionalGeneration` as the ``generator``.
    ...
    Args:
        config (:class:`~hf_paddle.RagConfig`):
            Model configuration class with all the parameters of the model. Initializing with a config file does not
            load the weights associated with the model, only the configuration. Check out the
            :meth:`~hf_paddle.TFPreTrainedModel.from_pretrained` method to load the model weights.
        question_encoder (:class:`hf_paddle.TFPreTrainedModel`):
            An encoder model compatible with the faiss index encapsulated by the ``retriever``.
        generator (:class:`hf_paddle.TFPreTrainedModel`):
            A seq2seq model used as the generator in the RAG architecture.
        retriever (:class:`~hf_paddle.RagRetriever`):
...
RAG_FORWARD_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            Indices of input sequence tokens in the vocabulary. :class:`~hf_paddle.RagConfig`, used to initialize
        ...
        encoder_outputs (:obj:`tuple(tuple(tf.Tensor)`, `optional`)
            ...
            Used by the (:class:`~hf_paddle.TFRagModel`) model during decoding.
        ...
        past_key_values (:obj:`tuple(tuple(tf.Tensor))`):
            ...
            :obj:`past_key_values` are used in the (:class:`~hf_paddle.RagTokenForGeneration`) model during
            decoding.
        doc_scores (:obj:`tf.Tensor` of shape :obj:`(batch_size, config.n_docs)`):
            Score between each retrieved document embeddings (see :obj:`retrieved_doc_embeds`) and
        ...
        context_input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
            ...
            forward pass. :obj:`context_input_ids` are returned by :meth:`~hf_paddle.RagRetriever.__call__`.
        context_attention_mask (:obj:`tf.Tensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
            Attention mask post-processed from the retrieved documents and the question encoder :obj:`input_ids` by the
            retriever.
            ...
            :meth:`~hf_paddle.RagRetriever.__call__`.
    ...
    def call(
        ...
        **kwargs
        ...
        Example::
            ...
            >>> from hf_paddle import RagTokenizer, RagRetriever, RagModel
        ...
        if encoder_outputs is None:
            ...
            if has_to_retrieve:
                ...
                # see https://github.com/huggingface/hf_paddle/blob/master/src/hf_paddle/models/dpr/modeling_tf_dpr.py#L91
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Adapted from https://github.com/huggingface/hf_paddle/blob/master/src/hf_paddle/modeling_tf_bart.py
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        Example::
            ...
            >>> from hf_paddle import RagTokenizer, RagRetriever, TFRagTokenForGeneration
        ...
        **model_kwargs
        ...
        Args:
            ...
            num_return_sequences(:obj:`int`, `optional`, defaults to 1):
                ...
                `:func:`~hf_paddle.generation_utils.GenerationMixin.generate` function, where we set
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        Example::
            ...
            >>> from hf_paddle import RagTokenizer, RagRetriever, TFRagSequenceForGeneration
    ...
    def generate(
        ...
        **model_kwargs
        ...
        :meth:`~hf_paddle.generation_utils.GenerationMixin.generate`` documentation for more information on how to
        ...
        Args:
            ...
            context_attention_mask (:obj:`tf.Tensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
                ...
                They are returned by :meth:`~hf_paddle.RagRetriever.__call__`.
            doc_scores (:obj:`tf.Tensor` of shape :obj:`(batch_size, config.n_docs)`):
                Score between each retrieved document embeddings (see :obj:`retrieved_doc_embeds`) and
                ...
                are returned by :meth:`~hf_paddle.RagRetriever.__call__`.
            ...
            n_docs (:obj:`int`, `optional`, defaults to :obj:`config.n_docs`)
                Number of documents to retrieve and/or number of documents for which to generate an answer.
            kwargs:
                Additional kwargs will be passed to :meth:`~hf_paddle.generation_utils.GenerationMixin.generate`
