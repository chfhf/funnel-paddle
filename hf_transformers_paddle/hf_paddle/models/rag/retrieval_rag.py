...
class Index:
    """
    A base class for the Indices encapsulated by the :class:`~hf_paddle.RagRetriever`.
    """
...
class RagRetriever:
    ...
    Args:
        ...
        question_encoder_tokenizer (:class:`~hf_paddle.PreTrainedTokenizer`):
            The tokenizer that was used to tokenize the question. It is used to decode the question and then use the
            generator_tokenizer.
        generator_tokenizer (:class:`~hf_paddle.PreTrainedTokenizer`):
            The tokenizer used for the generator part of the RagModel.
        index (:class:`~hf_paddle.models.rag.retrieval_rag.Index`, optional, defaults to the one defined by the configuration):
            If specified, use this index instead of the one built using the configuration

    Examples::

        >>> # To load the default "wiki_dpr" dataset with 21M passages from wikipedia (index name is 'compressed' or 'exact')
        >>> from hf_paddle import RagRetriever
    ...
    def __call__(
        ...
        Args:
            ...
            n_docs (:obj:`int`, `optional`):
                The number of docs retrieved per query.
            return_tensors (:obj:`str` or :class:`~hf_paddle.file_utils.TensorType`, `optional`, defaults to "pt"):
        ...
        Returns: :class:`~hf_paddle.BatchEncoding`: A :class:`~hf_paddle.BatchEncoding` with the following
        fields:
