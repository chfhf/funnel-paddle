...
class XLNetConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.XLNetModel` or a
    :class:`~hf_paddle.TFXLNetModel`. It is used to instantiate a XLNet model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32000):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.XLNetModel` or
            :class:`~hf_paddle.TFXLNetModel`.
        ...
        mem_len (:obj:`int` or :obj:`None`, `optional`):
            ...
            <https://huggingface.co/hf_paddle/quickstart.html#using-the-past>`__ for more information.
    ...
    Examples::
        ...
        >>> from hf_paddle import XLNetConfig, XLNetModel
