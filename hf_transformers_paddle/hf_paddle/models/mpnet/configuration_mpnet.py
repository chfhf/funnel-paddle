...
class MPNetConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.MPNetModel` or a
    :class:`~hf_paddle.TFMPNetModel`. It is used to instantiate a MPNet model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30527):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.MPNetModel` or
            :class:`~hf_paddle.TFMPNetModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import MPNetModel, MPNetConfig
