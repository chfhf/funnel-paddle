...
class ConvBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.ConvBertModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.ConvBertModel` or
            :class:`~hf_paddle.TFConvBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.ConvBertModel`
            or :class:`~hf_paddle.TFConvBertModel`.
    ...
    Example::
        >>> from hf_paddle import ConvBertModel, ConvBertConfig
