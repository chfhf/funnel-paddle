...
class GPTNeoConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.GPTNeoModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50257):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.GPTNeoModel`. Vocabulary size of the model.
            Defines the different tokens that can be represented by the `inputs_ids` passed to the forward method of
            :class:`~hf_paddle.GPTNeoModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.GPTNeoModel`.
        ...
        Example::
            ...
            >>> from hf_paddle import GPTNeoModel, GPTNeoConfig
