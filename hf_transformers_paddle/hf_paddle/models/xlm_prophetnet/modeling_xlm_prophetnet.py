...
class XLMProphetNetEncoder(ProphetNetEncoder):
    r"""
    This class overrides :class:`~hf_paddle.ProphetNetEncoder`. Please check the superclass for the appropriate
    documentation alongside usage examples.

    Example::

        >>> from hf_paddle import XLMProphetNetTokenizer, XLMProphetNetEncoder
...
class XLMProphetNetDecoder(ProphetNetDecoder):
    r"""
    This class overrides :class:`~hf_paddle.ProphetNetDecoder`. Please check the superclass for the appropriate
    documentation alongside usage examples.

    Example::

        >>> from hf_paddle import XLMProphetNetTokenizer, XLMProphetNetDecoder
        >>> import paddorch as torch
...
class XLMProphetNetModel(ProphetNetModel):
    r"""
    This class overrides :class:`~hf_paddle.ProphetNetModel`. Please check the superclass for the appropriate
    documentation alongside usage examples.

    Example::

        >>> from hf_paddle import XLMProphetNetTokenizer, XLMProphetNetModel
...
class XLMProphetNetForConditionalGeneration(ProphetNetForConditionalGeneration):
    r"""
    This class overrides :class:`~hf_paddle.ProphetNetForConditionalGeneration`. Please check the superclass for the
    appropriate documentation alongside usage examples.

    Example::

        >>> from hf_paddle import XLMProphetNetTokenizer, XLMProphetNetForConditionalGeneration
...
class XLMProphetNetForCausalLM(ProphetNetForCausalLM):
    r"""
    This class overrides :class:`~hf_paddle.ProphetNetForCausalLM`. Please check the superclass for the appropriate
    documentation alongside usage examples.

    Example::

        >>> from hf_paddle import XLMProphetNetTokenizer, XLMProphetNetForCausalLM
        >>> import paddorch as torch
        ...
        >>> from hf_paddle import EncoderDecoderModel, XLMProphetNetTokenizer, XLMRobertaTokenizer
        >>> import paddorch as torch
