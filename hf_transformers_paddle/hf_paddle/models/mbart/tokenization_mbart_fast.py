...
class MBartTokenizerFast(XLMRobertaTokenizerFast):
    ...
    :class:`~hf_paddle.MBartTokenizerFast` is a subclass of :class:`~hf_paddle.XLMRobertaTokenizerFast`. Refer to
    superclass :class:`~hf_paddle.XLMRobertaTokenizerFast` for usage examples and documentation concerning the
    ...
    Examples::
        ...
        >>> from hf_paddle import MBartTokenizerFast
