...
# Copied from hf_paddle.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_bart.BartAttention with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_bart.BartClassificationHead with Bart->MBart
...
MBART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.MBartConfig`):
...
MBART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from hf_paddle import MBartTokenizer, MBartForConditionalGeneration, MBartConfig
    ...
    Mask filling example::
        ...
        >>> from hf_paddle import MBartTokenizer, MBartForConditionalGeneration
        >>> tokenizer = MBartTokenizer.from_pretrained('facebook/mbart-large-cc25')
...
MBART_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.MBartTokenizer`. See
...
class MBartForSequenceClassification(MBartPreTrainedModel):
    ...
    # Copied from hf_paddle.models.bart.modeling_bart.BartForSequenceClassification.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
class MBartForQuestionAnswering(MBartPreTrainedModel):
    ...
    # Copied from hf_paddle.models.bart.modeling_bart.BartForQuestionAnswering.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
# Copied from hf_paddle.models.bart.modeling_bart.BartDecoderWrapper with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_bart.BartForCausalLM with Bart->MBart
class MBartForCausalLM(MBartPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import MBartTokenizer, MBartForCausalLM
