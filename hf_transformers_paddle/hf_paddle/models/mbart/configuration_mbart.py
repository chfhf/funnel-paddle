...
class MBartConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.MBartModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.MBartModel` or
            :class:`~hf_paddle.TFMBartModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import MBartModel, MBartConfig
