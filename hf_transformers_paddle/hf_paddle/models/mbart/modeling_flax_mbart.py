...
MBART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.MBartConfig`): Model configuration class with all the parameters of the model.
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->MBart
    ...
    def __call__(
        ...
        if attention_mask is not None:
            ...
            attention_bias = lax.select(
                ...
                jnp.full(attention_mask.shape, -1e+20).astype(self.dtype),
            )
        else:
            attention_bias = None
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartEncoderLayerCollection with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartDecoderLayerCollection with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartClassificationHead with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartModule with Bart->MBart
...
class FlaxMBartPreTrainedModel(FlaxPreTrainedModel):
    ...
    # Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartPreTrainedModel.init_cache with Bart->MBart
    ...
    def encode(
        ...
        Example::
            ...
            >>> from hf_paddle import MBartTokenizer, FlaxMBartForConditionalGeneration
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartForConditionalGenerationModule with Bart->MBart
...
FLAX_MBART_CONDITIONAL_GENERATION_DOCSTRING = r"""
    ...
    Summarization example::
        ...
        >>> from hf_paddle import MBartTokenizer, FlaxMBartForConditionalGeneration, MBartConfig
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartForSequenceClassificationModule with Bart->MBart
...
# Copied from hf_paddle.models.bart.modeling_flax_bart.FlaxBartForQuestionAnsweringModule with Bart->MBart
