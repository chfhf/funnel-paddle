...
class MBartTokenizer(XLMRobertaTokenizer):
    ...
    :class:`~hf_paddle.MBartTokenizer` is a subclass of :class:`~hf_paddle.XLMRobertaTokenizer`. Refer to
    superclass :class:`~hf_paddle.XLMRobertaTokenizer` for usage examples and documentation concerning the
    ...
    Examples::
        ...
        >>> from hf_paddle import MBartTokenizer
