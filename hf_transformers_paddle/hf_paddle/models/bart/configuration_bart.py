...
class BartConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.BartModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BartModel` or
            :class:`~hf_paddle.TFBartModel`.
        ...
        num_labels: (:obj:`int`, `optional`, defaults to 3):
            The number of labels to use in :class:`~hf_paddle.BartForSequenceClassification`.
    ...
    Example::
        ...
        >>> from hf_paddle import BartModel, BartConfig
