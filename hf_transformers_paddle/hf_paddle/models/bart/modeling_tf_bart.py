...
BART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~hf_paddle.BartConfig`): Model configuration class with all the parameters of the model.
...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from hf_paddle import BartTokenizer, TFBartForConditionalGeneration, BartConfig
    ...
    Mask filling example::
        ...
        >>> from hf_paddle import BartTokenizer, TFBartForConditionalGeneration
        >>> tokenizer = BartTokenizer.from_pretrained('facebook/bart-large')
