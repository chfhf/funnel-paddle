...
BART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.BartConfig`):
...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from hf_paddle import BartTokenizer, BartForConditionalGeneration, BartConfig
    ...
    Mask filling example::
        ...
        >>> from hf_paddle import BartTokenizer, BartForConditionalGeneration
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.BartTokenizer`. See
...
class BartForCausalLM(BartPretrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import BartTokenizer, BartForCausalLM
