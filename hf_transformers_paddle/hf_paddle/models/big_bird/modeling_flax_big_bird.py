...
class FlaxBigBirdForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.BigBirdForPreTraining`.
...
BIG_BIRD_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~hf_paddle.FlaxPreTrainedModel`. Check the superclass documentation for the
    ...
    Parameters:
        config (:class:`~hf_paddle.BigBirdConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the :meth:`~hf_paddle.FlaxPreTrainedModel.from_pretrained` method to load the
            model weights.
"""
...
BIG_BIRD_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`numpy.ndarray` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.BigBirdTokenizer`. See
            :meth:`hf_paddle.PreTrainedTokenizer.encode` and :func:`hf_paddle.PreTrainedTokenizer.__call__` for
            details.
...
class FlaxBigBirdEmbeddings(nn.Module):
    ...
    # Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertEmbeddings.setup
    def setup(self):
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertSelfAttention with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertSelfOutput with Bert->BigBird
...
class FlaxBigBirdAttention(nn.Module):
    ...
    # Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertAttention.__call__ with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertIntermediate with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertOutput with Bert->BigBird
...
class FlaxBigBirdLayer(nn.Module):
    ...
    # Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertLayer.__call__ with Bert->BigBird
...
class FlaxBigBirdLayerCollection(nn.Module):
    ...
    # Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertLayerCollection.__call__ with Bert->BigBird
    def __call__(
        self,
        hidden_states,
        attention_mask,
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertEncoder with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertPredictionHeadTransform with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertLMPredictionHead with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertOnlyMLMHead with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertModel with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForPreTrainingModule with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForPreTraining with Bert->BigBird
...
FLAX_BIG_BIRD_FOR_PRETRAINING_DOCSTRING = """
    ...
    Example::
        ...
        >>> from hf_paddle import BigBirdTokenizer, FlaxBigBirdForPreTraining
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForMaskedLMModule with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForMaskedLM with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForSequenceClassification with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForMultipleChoiceModule with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForTokenClassificationModule with Bert->BigBird
...
# Copied from hf_paddle.models.bert.modeling_flax_bert.FlaxBertForTokenClassification with Bert->BigBird
