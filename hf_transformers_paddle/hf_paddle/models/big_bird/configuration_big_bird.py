...
class BigBirdConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.BigBirdModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50358):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.BigBirdModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.BigBirdModel`.
        ...
        >>> from hf_paddle import BigBirdModel, BigBirdConfig
