    ...
    def forward(
        ...
        if causal_attention_mask is not None:
            if causal_attention_mask.shape != (bsz, 1, tgt_len, src_len):
                raise ValueError(
                    f"Attention mask should be of size {(bsz, 1, tgt_len, src_len)}, but is {causal_attention_mask.shape}"
                )
...
class CLIPEncoder(nn.Module):
    ...
    :class:`~hf_paddle.CLIPEncoderLayer`.
...
class CLIPTextModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import CLIPTokenizer, CLIPTextModel
...
class CLIPVisionModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> import requests
            >>> from hf_paddle import CLIPProcessor, CLIPVisionModel
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        Returns:
            ...
            obtained by applying the projection layer to the pooled output of :class:`~hf_paddle.CLIPTextModel`.

        Examples::

            >>> from hf_paddle import CLIPTokenizer, CLIPModel
    ...
    def get_image_features(
        ...
        Returns:
            ...
            obtained by applying the projection layer to the pooled output of :class:`~hf_paddle.CLIPVisionModel`.

        Examples::

            >>> from PIL import Image
            >>> import requests
            >>> from hf_paddle import CLIPProcessor, CLIPModel
