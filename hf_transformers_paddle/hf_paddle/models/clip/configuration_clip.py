...
class CLIPTextConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.CLIPModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 49408):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.CLIPModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import CLIPTextModel, CLIPTextConfig
...
class CLIPVisionConfig(PretrainedConfig):
    ...
    Example::
        ...
        >>> from hf_paddle import CLIPVisionModel, CLIPVisionConfig
...
class CLIPConfig(PretrainedConfig):
    r"""
    :class:`~hf_paddle.CLIPConfig` is the configuration class to store the configuration of a
    :class:`~hf_paddle.CLIPModel`. It is used to instantiate CLIP model according to the specified arguments,
    ...
    Args:
        text_config_dict (:obj:`dict`, `optional`):
            Dictionary of configuration options used to initialize :class:`~hf_paddle.CLIPTextConfig`.
        vision_config_dict (:obj:`dict`, `optional`):
            Dictionary of configuration options used to initialize :class:`~hf_paddle.CLIPVisionConfig`.
    ...
    def from_text_vision_configs(cls, text_config: CLIPTextConfig, vision_config: CLIPVisionConfig, **kwargs):
        r"""
        Instantiate a :class:`~hf_paddle.CLIPConfig` (or a derived class) from clip text model configuration and
    ...
    def to_dict(self):
        ...
        :meth:`~hf_paddle.PretrainedConfig.to_dict`.
