...
CLIP_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.CLIPConfig`): Model configuration class with all the parameters of the model.
...
CLIP_TEXT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`numpy.ndarray` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.CLIPTokenizer`. See
...
CLIP_VISION_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (:obj:`numpy.ndarray` of shape :obj:`(batch_size, num_channels, height, width)`):
            ...
            :class:`~hf_paddle.CLIPFeatureExtractor`. See :meth:`hf_paddle.CLIPFeatureExtractor.__call__` for
            details.
        output_attentions (:obj:`bool`, `optional`):
            Whether or not to return the attentions tensors of all attention layers. See ``attentions`` under returned
            tensors for more detail.
...
class FlaxCLIPPreTrainedModel(FlaxPreTrainedModel):
    ...
    def get_text_features(
        ...
        Returns:
            ...
            applying the projection layer to the pooled output of :class:`~hf_paddle.FlaxCLIPTextModel`.

        Examples::

            >>> from hf_paddle import CLIPTokenizer, FlaxCLIPModel
    ...
    def get_image_features(self, pixel_values, dropout_rng: jax.random.PRNGKey = None, train=False):
        ...
        Args:
            pixel_values (:obj:`numpy.ndarray` of shape :obj:`(batch_size, num_channels, height, width)`):
                ...
                using :class:`~hf_paddle.CLIPFeatureExtractor`. See
                :meth:`hf_paddle.CLIPFeatureExtractor.__call__` for details.

        Returns:
            image_features (:obj:`jnp.ndarray` of shape :obj:`(batch_size, output_dim`): The image embeddings obtained
            by applying the projection layer to the pooled output of :class:`~hf_paddle.FlaxCLIPVisionModel`

        Examples::

            >>> from PIL import Image
            >>> import requests
            >>> from hf_paddle import CLIPProcessor, FlaxCLIPModel
...
FLAX_CLIP_TEXT_MODEL_DOCSTRING = """
    ...
    Example::
        ...
        >>> from hf_paddle import CLIPTokenizer, FlaxCLIPTextModel
...
FLAX_CLIP_VISION_MODEL_DOCSTRING = """
    ...
    Example::
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from hf_paddle import CLIPProcessor, FlaxCLIPVisionModel
