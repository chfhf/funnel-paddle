...
class PegasusConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.PegasusModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.PegasusModel` or
            :class:`~hf_paddle.TFPegasusModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import PegasusModel, PegasusConfig
