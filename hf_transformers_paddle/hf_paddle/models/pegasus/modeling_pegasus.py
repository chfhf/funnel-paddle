...
# Copied from hf_paddle.models.bart.modeling_bart.shift_tokens_right
...
# Copied from hf_paddle.models.bart.modeling_bart._make_causal_mask
...
# Copied from hf_paddle.models.bart.modeling_bart._expand_mask
def _expand_mask(mask: torch.Tensor, dtype: torch.dtype, tgt_len: Optional[int] = None):
    ...
    expanded_mask = mask.unsqueeze(1).unsqueeze(1).expand(bsz, 1, tgt_len, src_len).to(dtype)
...
# Copied from hf_paddle.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Pegasus
class PegasusSinusoidalPositionalEmbedding(nn.Embedding):
    ...
    def _init_weight(out: nn.Parameter):
        ...
        out.stop_gradient = True  # set early to avoid an error in pytorch-1.8+
...
# Copied from hf_paddle.models.bart.modeling_bart.BartAttention with Bart->Pegasus
...
# Copied from hf_paddle.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Pegasus
...
# Copied from hf_paddle.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Pegasus
...
PEGASUS_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.PegasusConfig`):
...
PEGASUS_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from hf_paddle import PegasusTokenizer, PegasusForConditionalGeneration
...
class PegasusModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import PegasusTokenizer, PegasusModel
...
# Copied from hf_paddle.models.bart.modeling_bart.BartDecoderWrapper with Bart->Pegasus
...
# Copied from hf_paddle.models.bart.modeling_bart.BartForCausalLM with Bart->Pegasus
class PegasusForCausalLM(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import PegasusTokenizer, PegasusForCausalLM
