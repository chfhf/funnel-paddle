...
from hf_paddle import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from hf_paddle.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
