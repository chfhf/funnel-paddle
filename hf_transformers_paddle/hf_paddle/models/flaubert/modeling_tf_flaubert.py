...
# Copied from hf_paddle.models.xlm.modeling_tf_xlm.TFXLMMultiHeadAttention with XLM->Flaubert
...
# Copied from hf_paddle.models.xlm.modeling_tf_xlm.TFXLMTransformerFFN
...
# Copied from hf_paddle.models.xlm.modeling_tf_xlm.TFXLMPredLayer
...
class TFFlaubertWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~hf_paddle.TFFlaubertWithLMHeadModel` outputs.
