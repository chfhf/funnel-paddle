...
class FlaubertConfig(XLMConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.FlaubertModel` or a
    :class:`~hf_paddle.TFFlaubertModel`. It is used to instantiate a FlauBERT model according to the specified
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.FlaubertModel` or
            :class:`~hf_paddle.TFFlaubertModel`.
