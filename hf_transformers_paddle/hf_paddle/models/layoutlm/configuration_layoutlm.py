...
class LayoutLMConfig(BertConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.LayoutLMModel`. It is used to
    ...
    Configuration objects inherit from :class:`~hf_paddle.BertConfig` and can be used to control the model outputs.
    Read the documentation from :class:`~hf_paddle.BertConfig` for more information.


    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            Vocabulary size of the LayoutLM model. Defines the different tokens that can be represented by the
            `inputs_ids` passed to the forward method of :class:`~hf_paddle.LayoutLMModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed into :class:`~hf_paddle.LayoutLMModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import LayoutLMModel, LayoutLMConfig
