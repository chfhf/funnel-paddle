...
from hf_paddle import GPT2Config
...
def convert_megatron_checkpoint(args, input_state_dict, config):
    ...
    n_embed = pos_embeddings.shape[0]
    # DEBUG.
    ...
    for key, val in transformer.items():
        ...
        # Transpose the QKV matrix.
            ...
            # Megatron stores (3*D) x D but hf_paddle-GPT2 expects D x 3*D.
        ...
        # Transpose the weights.
            ...
            out_name = megatron_to_hf_paddle[op_name]
    ...
    # For LM head, hf_paddle' wants the matrix to weight embeddings.
