...
# Copied from hf_paddle.models.bert.modeling_bert.BertPooler with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertSelfOutput with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertAttention with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertIntermediate with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertOutput with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertLayer with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->RemBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RemBert
...
REMBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.RemBertConfig`): Model configuration class with all the parameters of the model.
...
REMBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`hf_paddle.RemBertTokenizer`. See
...
class RemBertForCausalLM(RemBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import RemBertTokenizer, RemBertForCausalLM, RemBertConfig
            >>> import paddorch as torch
