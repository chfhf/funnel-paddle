...
class RemBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.RemBertModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 250300):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.RemBertModel` or
            :class:`~hf_paddle.TFRemBertModel`. Vocabulary size of the model. Defines the different tokens that can
            be represented by the `inputs_ids` passed to the forward method of :class:`~hf_paddle.RemBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.RemBertModel` or
            :class:`~hf_paddle.TFRemBertModel`.
        ...
        >>> from hf_paddle import RemBertModel, RemBertConfig
