...
class DebertaConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.DebertaModel` or a
    :class:`~hf_paddle.TFDebertaModel`. It is used to instantiate a DeBERTa model according to the specified
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.DebertaModel` or
            :class:`~hf_paddle.TFDebertaModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.DebertaModel` or
            :class:`~hf_paddle.TFDebertaModel`.
