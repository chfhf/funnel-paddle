...
from paddorch.autograd.function import Function
...
class EfficientAttentionMixin:
    ...
    def _merge_hidden_size_dims(self, x, num_attn_heads, attn_head_size):
        ...
        """
        x = x.permute(0, 2, 1, 3)
        return torch.reshape(x, (x.shape[0], -1, num_attn_heads * attn_head_size))
...
class LSHSelfAttention(nn.Module, EfficientAttentionMixin):
    ...
    def _get_sorted_bucket_idx_and_undo_sorted_bucket_idx(self, sequence_length, buckets, num_hashes):
        ...
        with torch.no_grad():
            ...
            # get undo sort
            undo_sorted_bucket_idx = sorted_bucket_idx.new(*sorted_bucket_idx.shape)
    ...
    def _attend(
        ...
        query_key_dots = torch.matmul(query_vectors, key_vectors,True)
...
class ReformerModelOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.ReformerModel`.
...
class ReformerModelWithLMHeadOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.ReformerModelWithLMHead`.
...
REFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.ReformerConfig`): Model configuration class with all the parameters of the model.
...
REFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.ReformerTokenizer`. See
        ...
        num_hashes (:obj:`int`, `optional`):
            ...
            For more information, see :obj:`num_hashes` in :class:`~hf_paddle.ReformerConfig`.
