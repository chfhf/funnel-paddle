...
from paddorch.nn import CrossEntropyLoss, SmoothL1Loss
...
class LxmertForQuestionAnsweringOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.LxmertForQuestionAnswering`.
...
class LxmertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.LxmertForPreTraining`.
...
class LxmertLMPredictionHead(nn.Module):
    def __init__(self, config, lxmert_model_embedding_weights):
        ...
        self.bias = nn.Parameter(torch.zeros(lxmert_model_embedding_weights.shape[0]))
...
LXMERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.LxmertConfig`): Model configuration class with all the parameters of the model.
...
LXMERT_INPUTS_DOCSTRING = r"""
    ...
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.LxmertTokenizer`. See
        ...
        visual_feats: (:obj:`torch.FloatTensor` of shape :obj:՝(batch_size, num_visual_features, visual_feat_dim)՝):
            ...
            These are currently not provided by the hf_paddle library.
