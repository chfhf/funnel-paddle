...
class LxmertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.LxmertModel` or a
    :class:`~hf_paddle.TFLxmertModel`. It is used to instantiate a LXMERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.LxmertModel` or
            :class:`~hf_paddle.TFLxmertModel`.
