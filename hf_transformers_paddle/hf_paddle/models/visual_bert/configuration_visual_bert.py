...
class VisualBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.VisualBertModel`. It is used
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.VisualBertModel`. Vocabulary size of the
            model. Defines the different tokens that can be represented by the ``inputs_ids`` passed to the forward
            method of :class:`~hf_paddle.VisualBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            ...
            :class:`~hf_paddle.VisualBertModel`.
        ...
        bypass_transformer (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            the model directly concatenates the visual embeddings from :class:`~hf_paddle.VisualBertEmbeddings` with
            text output from hf_paddle, and then pass it to a self-attention layer.
    ...
    Example::
        ...
        >>> from hf_paddle import VisualBertModel, VisualBertConfig
