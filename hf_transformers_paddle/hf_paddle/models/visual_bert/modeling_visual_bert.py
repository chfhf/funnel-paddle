...
from paddorch.nn import CrossEntropyLoss, KLDivLoss, LogSoftmax
        ...
        if visual_embeds is not None:
            if visual_token_type_ids is None:
                visual_token_type_ids = torch.ones(
                    visual_embeds.shape[:-1], dtype=torch.long, device=self.position_ids.device
                )
            ...
            if image_text_alignment is not None:
                ...
                visual_position_ids = torch.zeros(
                    *visual_embeds.shape[:-1], dtype=torch.long, device=visual_embeds.device
                )
...
# Copied from hf_paddle.models.bert.modeling_bert.BertSelfOutput with Bert->VisualBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertIntermediate with Bert->VisualBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertOutput with Bert->VisualBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertPooler with Bert->VisualBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->VisualBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertLMPredictionHead with Bert->VisualBert
...
# Copied from hf_paddle.models.bert.modeling_bert.BertPreTrainingHeads with Bert->VisualBert
...
class VisualBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.VisualBertForPreTraining`.
...
VISUAL_BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.VisualBertConfig`): Model configuration class with all the parameters of the model.
...
class VisualBertModel(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import BertTokenizer, VisualBertModel
            >>> import paddorch as torch
...
class VisualBertForPreTraining(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import BertTokenizer, VisualBertForPreTraining
...
class VisualBertForMultipleChoice(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import BertTokenizer, VisualBertForMultipleChoice
            >>> import paddorch as torch
...
class VisualBertForQuestionAnswering(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> # Assumption: `get_visual_embeddings(image)` gets the visual embeddings of the image in the batch.
            >>> from hf_paddle import BertTokenizer, VisualBertForQuestionAnswering
            >>> import paddorch as torch
        ...
        index_to_gather = (
            index_to_gather.unsqueeze(-1).unsqueeze(-1).expand(index_to_gather.shape[0], 1, sequence_output.shape[-1])
        )
...
class VisualBertForVisualReasoning(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> # Assumption: `get_visual_embeddings(image)` gets the visual embeddings of the image in the batch.
            >>> from hf_paddle import BertTokenizer, VisualBertForVisualReasoning
            >>> import paddorch as torch
...
class VisualBertForRegionToPhraseAlignment(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> # Assumption: `get_visual_embeddings(image)` gets the visual embeddings of the image in the batch.
            >>> from hf_paddle import BertTokenizer, VisualBertForRegionToPhraseAlignment
            >>> import paddorch as torch
