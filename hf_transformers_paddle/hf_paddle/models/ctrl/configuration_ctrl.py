...
class CTRLConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.CTRLModel` or a
    :class:`~hf_paddle.TFCTRLModel`. It is used to instantiate a CTRL model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 246534):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.CTRLModel` or
            :class:`~hf_paddle.TFCTRLModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import CTRLModel, CTRLConfig
