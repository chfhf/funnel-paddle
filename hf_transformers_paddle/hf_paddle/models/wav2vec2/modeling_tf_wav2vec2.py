...
# Copied from hf_paddle.models.bart.modeling_tf_bart.TFBartAttention with TFBart->TFWav2Vec2
...
class TFWav2Vec2Model(TFWav2Vec2PreTrainedModel):
    ...
    def call(
        ...
        Example::
            ...
            >>> from hf_paddle import Wav2Vec2Processor, TFWav2Vec2Model
...
class TFWav2Vec2ForCTC(TFWav2Vec2PreTrainedModel):
    ...
    def call(
        ...
        Example::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import Wav2Vec2Processor, TFWav2Vec2ForCTC
            >>> from datasets import load_dataset
            >>> import soundfile as sf
