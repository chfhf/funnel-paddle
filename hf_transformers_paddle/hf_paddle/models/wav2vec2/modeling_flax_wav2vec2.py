...
class FlaxWav2Vec2BaseModelOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.FlaxWav2Vec2BaseModelOutput`, with potential hidden states and attentions.
...
class FlaxWav2Vec2ForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.FlaxWav2Vec2ForPreTrainingOutput`, with potential hidden states and
    attentions.
...
FLAX_WAV2VEC2_MODEL_DOCSTRING = """
    ...
    Example::
        ...
        >>> from hf_paddle import Wav2Vec2Processor, FlaxWav2Vec2Model
...
FLAX_WAV2VEC2_FOR_CTC_DOCSTRING = """
    ...
    Example::
        ...
        >>> import jax.numpy as jnp
        >>> from hf_paddle import Wav2Vec2Processor, FlaxWav2Vec2ForCTC
        >>> from datasets import load_dataset
        >>> import soundfile as sf
...
FLAX_WAV2VEC2_FOR_PRETRAINING_DOCSTRING = """
    ...
    Example::
        ...
        >>> import numpy as np
        >>> import jax.numpy as jnp
        >>> from hf_paddle import Wav2Vec2FeatureExtractor, FlaxWav2Vec2ForPreTraining
        >>> from hf_paddle.models.wav2vec2.modeling_flax_wav2vec2 import _compute_mask_indices
        >>> from datasets import load_dataset
        >>> import soundfile as sf
