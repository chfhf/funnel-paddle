...
class Wav2Vec2CTCTokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~hf_paddle.PreTrainedTokenizer` which contains some of the main methods.
    ...
    Args:
        ...
        **kwargs
            Additional keyword arguments passed along to :class:`~hf_paddle.PreTrainedTokenizer`
    """
...
class Wav2Vec2Tokenizer(PreTrainedTokenizer):
    ...
    Args:
        ...
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~hf_paddle.Wav2Vec2Tokenizer.__call__` should return :obj:`attention_mask`.
