...
class LukeTokenizer(RobertaTokenizer):
    ...
    This tokenizer inherits from :class:`~hf_paddle.RobertaTokenizer` which contains most of the main methods. Users
    should refer to this superclass for more information regarding those methods. Compared to
    :class:`~hf_paddle.RobertaTokenizer`, :class:`~hf_paddle.LukeTokenizer` also creates entity sequences, namely
    ...
    def __init__(
        ...
        **kwargs
        ...
        # for more information about lstrip and rstrip, see https://github.com/huggingface/hf_paddle/pull/2778
        entity_token_1 = (
        ...
        **kwargs
        ...
        if return_offsets_mapping:
            raise NotImplementedError(
                ...
                "https://github.com/huggingface/hf_paddle/pull/2674"
            )
