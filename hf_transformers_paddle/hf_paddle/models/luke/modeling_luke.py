...
class LukeSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if self.use_entity_aware_attention and entity_hidden_states is not None:
            ...
            w2w_attention_scores = torch.matmul(w2w_query_layer, w2w_key_layer,True)
            w2e_attention_scores = torch.matmul(w2e_query_layer, w2e_key_layer,True)
            e2w_attention_scores = torch.matmul(e2w_query_layer, e2w_key_layer,True)
            e2e_attention_scores = torch.matmul(e2e_query_layer, e2e_key_layer,True)
...
LUKE_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.LukeConfig`): Model configuration class with all the parameters of the
...
LUKE_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.LukeTokenizer`. See
...
class LukeModel(LukePreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import LukeTokenizer, LukeModel
...
class LukeForEntityClassification(LukePreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import LukeTokenizer, LukeForEntityClassification
...
class LukeForEntityPairClassification(LukePreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import LukeTokenizer, LukeForEntityPairClassification
...
class LukeForEntitySpanClassification(LukePreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import LukeTokenizer, LukeForEntitySpanClassification
