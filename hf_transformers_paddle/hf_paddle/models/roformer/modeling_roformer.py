...
# Copied from hf_paddle.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->RoFormer
...
# Copied from hf_paddle.models.bert.modeling_bert.BertSelfOutput with Bert->RoFormer
...
class RoFormerAttention(nn.Module):
    # Copied from hf_paddle.models.bert.modeling_bert.BertAttention.__init__ with Bert->RoFormer
    def __init__(self, config):
        super().__init__()
    ...
    # End Copy
    # Copied from hf_paddle.models.bert.modeling_bert.BertAttention.prune_heads
...
# Copied from hf_paddle.models.bert.modeling_bert.BertIntermediate with Bert->RoFormer
...
# Copied from hf_paddle.models.bert.modeling_bert.BertOutput with Bert->RoFormer
...
class RoFormerLayer(nn.Module):
    # Copied from hf_paddle.models.bert.modeling_bert.BertLayer.__init__ with Bert->RoFormer
    def __init__(self, config):
        super().__init__()
...
# Copied from hf_paddle.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RoFormer
...
ROFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.RoFormerConfig`): Model configuration class with all the parameters of the model.
...
ROFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`hf_paddle.RoFormerTokenizer`. See
...
class RoFormerForCausalLM(RoFormerPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from hf_paddle import RoFormerTokenizer, RoFormerForCausalLM, RoFormerConfig
            >>> import paddorch as torch
