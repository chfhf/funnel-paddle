...
class RoFormerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.RoFormerModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50000):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.RoFormerModel` or
            :class:`~hf_paddle.TFRoFormerModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.RoFormerModel`
            or :class:`~hf_paddle.TFRoFormerModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import RoFormerModel, RoFormerConfig
