...
# Copied from hf_paddle.models.roberta.modeling_tf_roberta.TFRobertaLMHead with Roberta->Longformer
...
# Copied from hf_paddle.models.roberta.modeling_tf_roberta.TFRobertaEmbeddings with Roberta->Longformer
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Longformer
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertOutput with Bert->Longformer
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertPooler with Bert->Longformer
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Longformer
...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.LongformerConfig`): Model configuration class with all the parameters of the model.
...
class TFLongformerModel(TFLongformerPreTrainedModel):
    ...
    This class copies code from :class:`~hf_paddle.TFRobertaModel` and overwrites standard self-attention with
