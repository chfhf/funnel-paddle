...
class LongformerConfig(RobertaConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.LongformerModel` or a
    :class:`~hf_paddle.TFLongformerModel`. It is used to instantiate a Longformer model according to the specified
    arguments, defining the model architecture.

    This is the configuration class to store the configuration of a :class:`~hf_paddle.LongformerModel`. It is used
    ...
    The :class:`~hf_paddle.LongformerConfig` class directly inherits :class:`~hf_paddle.RobertaConfig`. It reuses
    ...
    Example::
        ...
        >>> from hf_paddle import LongformerConfig, LongformerModel
