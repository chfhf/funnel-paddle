...
class LongformerSelfAttention(nn.Module):
    ...
    def _chunk(hidden_states, window_overlap):
        ...
        hidden_states = hidden_states.view(
            ...
            hidden_states.shape[1] // (window_overlap * 2),
            window_overlap * 2,
...
# Copied from hf_paddle.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Longformer
...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.LongformerConfig`): Model configuration class with all the parameters of the
...
LONGFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.LongformerTokenizer`. See
...
class LongformerModel(LongformerPreTrainedModel):
    """
    This class copied code from :class:`~hf_paddle.RobertaModel` and overwrote standard self-attention with
    ...
    def forward(
        ...
        Examples::
            ...
            >>> import paddorch as torch
            >>> from hf_paddle import LongformerModel, LongformerTokenizer
...
class LongformerForMaskedLM(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> import paddorch as torch
            >>> from hf_paddle import LongformerForMaskedLM, LongformerTokenizer
...
class LongformerForQuestionAnswering(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import LongformerTokenizer, LongformerForQuestionAnswering
            >>> import paddorch as torch
