...
class TFAlbertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.TFAlbertForPreTraining`.
...
ALBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~hf_paddle.AlbertConfig`): Model configuration class with all the parameters of the model.
...
ALBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.AlbertTokenizer`. See
    ...
    def call(
        ...
        **kwargs,
        ...
        Example::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import AlbertTokenizer, TFAlbertForPreTraining
