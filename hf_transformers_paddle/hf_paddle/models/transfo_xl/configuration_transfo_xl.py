...
class TransfoXLConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.TransfoXLModel` or a
    :class:`~hf_paddle.TFTransfoXLModel`. It is used to instantiate a Transformer-XL model according to the
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 267735):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.TransfoXLModel` or
            :class:`~hf_paddle.TFTransfoXLModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import TransfoXLConfig, TransfoXLModel
