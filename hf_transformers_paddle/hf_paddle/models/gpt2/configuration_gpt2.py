...
from hf_paddle import PreTrainedTokenizer, TensorType, is_torch_available
...
class GPT2Config(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.GPT2Model` or a
    :class:`~hf_paddle.TFGPT2Model`. It is used to instantiate a GPT-2 model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50257):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.GPT2Model` or
            :class:`~hf_paddle.TFGPT2Model`.
        ...
        summary_type (:obj:`string`, `optional`, defaults to :obj:`"cls_index"`):
            Argument used when doing sequence summary, used in the models :class:`~hf_paddle.GPT2DoubleHeadsModel`
            and :class:`~hf_paddle.TFGPT2DoubleHeadsModel`.
        ...
        summary_activation (:obj:`str`, `optional`):
            ...
            :class:`~hf_paddle.GPT2DoubleHeadsModel`.
    ...
    Example::
        ...
        >>> from hf_paddle import GPT2Model, GPT2Config
