    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import GPT2Tokenizer, TFGPT2DoubleHeadsModel
...
@add_start_docstrings(
    ...
    :class:`~hf_paddle.TFGPT2ForSequenceClassification` uses the last token in order to do the classification, as
