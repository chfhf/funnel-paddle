...
BEIT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.BeitConfig`): Model configuration class with all the parameters of the model.
...
BEIT_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_channels, height, width)`):
            Pixel values. Pixel values can be obtained using :class:`~hf_paddle.BeitFeatureExtractor`. See
            :meth:`hf_paddle.BeitFeatureExtractor.__call__` for details.
...
class BeitModel(BeitPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import BeitFeatureExtractor, BeitModel
...
class BeitForMaskedImageModeling(BeitPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import BeitFeatureExtractor, BeitForMaskedImageModeling
            >>> from PIL import Image
            >>> import requests
...
class BeitForImageClassification(BeitPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import BeitFeatureExtractor, BeitForImageClassification
            >>> from PIL import Image
            >>> import requests
