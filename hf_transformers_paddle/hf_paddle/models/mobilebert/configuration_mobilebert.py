...
class MobileBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.MobileBertModel` or a
    :class:`~hf_paddle.TFMobileBertModel`. It is used to instantiate a MobileBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.MobileBertModel` or
            :class:`~hf_paddle.TFMobileBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.MobileBertModel`
            or :class:`~hf_paddle.TFMobileBertModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import MobileBertModel, MobileBertConfig
