...
class TFMobileBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.TFMobileBertForPreTraining`.
...
MOBILEBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.MobileBertConfig`): Model configuration class with all the parameters of the model.
...
MOBILEBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.MobileBertTokenizer`. See
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import MobileBertTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import MobileBertTokenizer, TFMobileBertForNextSentencePrediction
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForNextSentencePrediction.serving_output
