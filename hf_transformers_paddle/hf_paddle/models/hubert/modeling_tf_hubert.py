...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.input_values_processing
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2._sample_without_replacement
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2._scatter_values_on_batch_indices
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2._compute_mask_indices
...
# Copied from hf_paddle.models.bart.modeling_tf_bart._expand_mask
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2GroupNorm with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2WeightNormConv1D with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2NoLayerNormConvLayer with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2LayerNormConvLayer with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2GroupNormConvLayer with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2PositionalConvEmbedding with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2SamePadLayer with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.bart.modeling_tf_bart.TFBartAttention with TFBart->TFHubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2FeedForward with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2EncoderLayer with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2EncoderLayerStableLayerNorm with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2Encoder with Wav2Vec2->Hubert
...
# Copied from hf_paddle.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2EncoderStableLayerNorm with Wav2Vec2->Hubert
...
HUBERT_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~hf_paddle.TFPreTrainedModel`. Check the superclass documentation for the
    ...
    Args:
        config (:class:`~hf_paddle.HubertConfig`): Model configuration class with all the parameters of the model.
...
HUBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_values (:obj:`np.ndarray`, :obj:`tf.Tensor`, :obj:`List[tf.Tensor]` :obj:`Dict[str, tf.Tensor]` or :obj:`Dict[str, np.ndarray]` and each example must have the shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.BertTokenizer`. See
            :func:`hf_paddle.PreTrainedTokenizer.__call__` and :func:`hf_paddle.PreTrainedTokenizer.encode` for
            details.
        ...
        return_dict (:obj:`bool`, `optional`):
            Whether or not to return a :class:`~hf_paddle.file_utils.ModelOutput` instead of a plain tuple. This
...
class TFHubertModel(TFHubertPreTrainedModel):
    ...
    def call(
        ...
        Example::
            ...
            >>> from hf_paddle import Wav2Vec2Processor, TFHubertModel
...
class TFHubertForCTC(TFHubertPreTrainedModel):
    ...
    def call(
        ...
        Example::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import Wav2Vec2Processor, TFHubertForCTC
            >>> from datasets import load_dataset
            >>> import soundfile as sf
