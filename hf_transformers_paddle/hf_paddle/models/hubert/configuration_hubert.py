...
class HubertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.HubertModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.HubertModel`. Vocabulary size of the model.
            Defines the different tokens that can be represented by the `inputs_ids` passed to the forward method of
            :class:`~hf_paddle.HubertModel`.
        ...
        ctc_loss_reduction (:obj:`str`, `optional`, defaults to :obj:`"sum"`):
            ...
            instance of :class:`~hf_paddle.HubertForCTC`.
    ...
    Example::
        ...
        >>> from hf_paddle import HubertModel, HubertConfig
