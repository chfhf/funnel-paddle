...
class MegatronBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.MegatronBertModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 29056):
            ...
            by the :obj:`inputs_ids` passed when calling :class:`~hf_paddle.MegatronBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            ...
            :class:`~hf_paddle.MegatronBertModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import MegatronBertModel, MegatronBertConfig
