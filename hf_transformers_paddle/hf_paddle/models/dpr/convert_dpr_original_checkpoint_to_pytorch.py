...
from paddorch.serialization import default_restore_location

from .hf_paddle import BertConfig, DPRConfig, DPRContextEncoder, DPRQuestionEncoder, DPRReader
...
class DPRContextEncoderState(DPRState):
    def load_dpr_model(self):
        ...
        # Fix changes from https://github.com/huggingface/hf_paddle/commit/614fef1691edb806de976756d4948ecbcd0c0ca3
