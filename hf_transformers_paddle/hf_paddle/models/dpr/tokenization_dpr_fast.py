...
class DPRContextEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~hf_paddle.DPRContextEncoderTokenizerFast` is identical to :class:`~hf_paddle.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~hf_paddle.BertTokenizerFast` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~hf_paddle.DPRQuestionEncoderTokenizerFast` is identical to :class:`~hf_paddle.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizerFast(CustomDPRReaderTokenizerMixin, BertTokenizerFast):
    ...
    :class:`~hf_paddle.DPRReaderTokenizerFast` is almost identical to :class:`~hf_paddle.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs
    strings: question, titles and texts that are combined to be fed to the :class:`~hf_paddle.DPRReader` model.
