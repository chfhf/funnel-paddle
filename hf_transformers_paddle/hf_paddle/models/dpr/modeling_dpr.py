...
class DPRContextEncoderOutput(ModelOutput):
    """
    Class for outputs of :class:`~hf_paddle.DPRQuestionEncoder`.
...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class DPRReader(DPRPretrainedReader):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from hf_paddle import DPRReader, DPRReaderTokenizer
