...
class DPRContextEncoderTokenizer(BertTokenizer):
    ...
    :class:`~hf_paddle.DPRContextEncoderTokenizer` is identical to :class:`~hf_paddle.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~hf_paddle.BertTokenizer` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizer(BertTokenizer):
    ...
    :class:`~hf_paddle.DPRQuestionEncoderTokenizer` is identical to :class:`~hf_paddle.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizer(CustomDPRReaderTokenizerMixin, BertTokenizer):
    ...
    :class:`~hf_paddle.DPRReaderTokenizer` is almost identical to :class:`~hf_paddle.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs strings:
    question, titles and texts that are combined to be fed to the :class:`~hf_paddle.DPRReader` model.
