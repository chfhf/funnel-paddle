...
class ElectraConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~hf_paddle.ElectraModel` or a
    :class:`~hf_paddle.TFElectraModel`. It is used to instantiate a ELECTRA model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.ElectraModel` or
            :class:`~hf_paddle.TFElectraModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~hf_paddle.ElectraModel` or
            :class:`~hf_paddle.TFElectraModel`.
    ...
    Examples::
        ...
        >>> from hf_paddle import ElectraModel, ElectraConfig
