...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Electra
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Electra
...
# Copied from from hf_paddle.models.bert.modeling_tf_bert.TFBertAttention with Bert->Electra
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Electra
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertOutput with Bert->Electra
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertLayer with Bert->Electra
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Electra
...
# Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertPooler with Bert->Electra
...
# Copied from hf_paddle.models.albert.modeling_tf_albert.TFAlbertEmbeddings with Albert->Electra
class TFElectraEmbeddings(tf.keras.layers.Layer):
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertEmbeddings.call
    def call(
        self,
...
class TFElectraForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~hf_paddle.TFElectraForPreTraining`.
...
ELECTRA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.ElectraConfig`): Model configuration class with all the parameters of the model.
...
ELECTRA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~hf_paddle.ElectraTokenizer`. See
...
class TFElectraModel(TFElectraPreTrainedModel):
    ...
    # Copied from hf_paddle.models.distilbert.modeling_tf_distilbert.TFDistilBertModel.serving_output
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from hf_paddle import ElectraTokenizer, TFElectraForPreTraining
...
class TFElectraForMaskedLM(TFElectraPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForMaskedLM.serving_output
...
class TFElectraForSequenceClassification(TFElectraPreTrainedModel, TFSequenceClassificationLoss):
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForSequenceClassification.serving_output
...
class TFElectraForMultipleChoice(TFElectraPreTrainedModel, TFMultipleChoiceLoss):
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForMultipleChoice.serving
    def serving(self, inputs: Dict[str, tf.Tensor]):
        output = self.call(input_ids=inputs)

        return self.serving_output(output)

    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForMultipleChoice.serving_output
...
class TFElectraForTokenClassification(TFElectraPreTrainedModel, TFTokenClassificationLoss):
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForTokenClassification.serving_output
...
class TFElectraForQuestionAnswering(TFElectraPreTrainedModel, TFQuestionAnsweringLoss):
    ...
    # Copied from hf_paddle.models.bert.modeling_tf_bert.TFBertForQuestionAnswering.serving_output
