    ...
    def call(
        ...
        **kwargs,
        ...
        if inputs["cache"] is not None:
            inputs["cache"]["slen"] += tensor.shape[1]
...
class TFXLMWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~hf_paddle.TFXLMWithLMHeadModel` outputs.
...
XLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.XLMConfig`): Model configuration class with all the parameters of the model.
