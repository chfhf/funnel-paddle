...
class XLMConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~hf_paddle.XLMModel` or a
    :class:`~hf_paddle.TFXLMModel`. It is used to instantiate a XLM model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            :obj:`inputs_ids` passed when calling :class:`~hf_paddle.XLMModel` or :class:`~hf_paddle.TFXLMModel`.
        ...
        use_lang_emb (:obj:`bool`, `optional`, defaults to :obj:`True`)
            ...
            models page <http://huggingface.co/hf_paddle/multilingual.html#xlm-language-embeddings>`__ for
    ...
    Examples::
        ...
        >>> from hf_paddle import XLMConfig, XLMModel
