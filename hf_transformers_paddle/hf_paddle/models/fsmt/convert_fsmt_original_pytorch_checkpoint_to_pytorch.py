...
from hf_paddle import FSMTConfig, FSMTForConditionalGeneration
from hf_paddle.file_utils import WEIGHTS_NAME
from hf_paddle.models.fsmt.tokenization_fsmt import VOCAB_FILES_NAMES
from hf_paddle.tokenization_utils_base import TOKENIZER_CONFIG_FILE
...
def convert_fsmt_checkpoint_to_pytorch(fsmt_checkpoint_path, pytorch_dump_folder_path):
    ...
    print(f"hf_paddle-cli upload {model_dir}")
