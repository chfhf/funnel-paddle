...
# Copied from hf_paddle.models.bart.modeling_bart.BartAttention with Bart->M2M100
...
# Copied from hf_paddle.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->M2M100
...
# Copied from hf_paddle.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->M2M100
...
M2M_100_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~hf_paddle.M2M100Config`):
...
M2M_100_GENERATION_EXAMPLE = r"""
    Translation example::
        ...
        >>> from hf_paddle import M2M100Tokenizer, M2M100ForConditionalGeneration
...
M2M_100_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~hf_paddle.M2M100Tokenizer`. See
