...
from paddorch.optim import Optimizer
from paddorch.optim.lr_scheduler import LambdaLR
...
class Adafactor(Optimizer):
    ...
    *warmup_init* options. To use a manual (external) learning rate schedule you should set `scale_parameter=False` and
    ...
    Recommended T5 finetuning settings (https://discuss.huggingface.co/t/t5-finetuning-tips/684/3):
        ...
        When using ``lr=None`` with :class:`~hf_paddle.Trainer` you will most likely need to use :class:`~hf_paddle.optimization.AdafactorSchedule` scheduler as following::

            from hf_paddle.optimization import Adafactor, AdafactorSchedule
...
class AdafactorSchedule(LambdaLR):
    """
    Since :class:`~hf_paddle.optimization.Adafactor` performs its own scheduling, if the training loop relies on a
...
def get_adafactor_schedule(optimizer, initial_lr=0.0):
    """
    Get a proxy schedule for :class:`~hf_paddle.optimization.Adafactor`
    ...
    Return:
        :class:`~hf_paddle.optimization.Adafactor` proxy schedule object.
