...
def keras_serializable(cls):
    ...
    1. Adding a :obj:`hf_paddle_config` dict to the Keras config dictionary in :obj:`get_config` (called by Keras at
       serialization time.
    2. Wrapping :obj:`__init__` to accept that :obj:`hf_paddle_config` dict (passed by Keras at deserialization
...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin, PushToHubMixin):
    ...
    :class:`~hf_paddle.TFPreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    def serving_output(output):
        ...
        Args:
            output (:obj:`~hf_paddle.TFBaseModelOutput`):
    ...
    def save_pretrained(self, save_directory, saved_model=False, version=1, push_to_hub=False, **kwargs):
        ...
        :func:`~hf_paddle.TFPreTrainedModel.from_pretrained` class method.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Parameters:
            ...
            config (:obj:`Union[PretrainedConfig, str]`, `optional`):
                Can be either:
                    ...
                    - a string valid as input to :func:`~hf_paddle.PretrainedConfig.from_pretrained`.
                ...
                be automatically loaded when:
                    ...
                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :func:`~hf_paddle.TFPreTrainedModel.save_pretrained` and is reloaded
        ...
        Examples::
            ...
            >>> from hf_paddle import BertConfig, TFBertModel
