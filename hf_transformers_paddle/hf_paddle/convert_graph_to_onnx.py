...
from hf_paddle.file_utils import ModelOutput, is_tf_available, is_torch_available
from hf_paddle.pipelines import Pipeline, pipeline
...
class OnnxConverterArgumentParser(ArgumentParser):
    """
    Wraps all the script arguments supported to export hf_paddle models to ONNX IR
    """
...
def convert_pytorch(nlp: Pipeline, opset: int, output: Path, use_external_format: bool):
    ...
    from paddorch.onnx import export
        ...
        if args.quantize:
            ...
            if args.framework == "tf":
                print(
                    ...
                    "\t\thttps://github.com/microsoft/onnxruntime/tree/master/onnxruntime/python/tools/hf_paddle\n"
                )
