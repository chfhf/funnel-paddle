...
from paddlenlp.transformers.funnel.modeling import FunnelForQuestionAnswering
from paddlenlp.metrics.squad import squad_evaluate, compute_prediction
from paddlenlp.datasets import load_dataset

from paddlenlp.transformers.funnel.tokenizer import FunnelTokenizerFast
...
def prepare_validation_features(examples, tokenizer, args):
    ...
    tokenized_examples = tokenizer(
        ...
        max_seq_len=args.max_seq_length,return_overflowing_tokens=True,
...
tokenizer = FunnelTokenizerFast.from_pretrained(args.model_name_or_path)
...
model = FunnelForQuestionAnswering.from_pretrained(args.model_name_or_path)
model.eval()
...
with paddle.no_grad():
    for batch in dev_data_loader:
        ...
        start_logits_tensor, end_logits_tensor = model(input_ids,token_type_ids=token_type_ids, attention_mask=attention_mask)
